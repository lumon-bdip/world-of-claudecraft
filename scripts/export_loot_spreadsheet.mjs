...
const NEW_LOOT_ADDED = [
  { itemId: 'valeborn_spellblade', section: 'Open World Rare Spawn', subgroup: 'Greywillow Vale rare chase table' },
  { itemId: 'bristleback_maul', section: 'Open World Rare Spawn', subgroup: 'Greywillow Vale - Elder Bristleback' },
  { itemId: 'sableweb_slippers', section: 'Open World Rare Spawn', subgroup: 'Greywillow Vale - Sableweb Matriarch' },
  { itemId: 'moggers_stomper_boots', section: 'Open World Rare Spawn', subgroup: 'Greywillow Vale - Brughol' },
  { itemId: 'moggers_copper_cudgel', section: 'Open World Rare Spawn', subgroup: 'Greywillow Vale rare chase table' },
  { itemId: 'moggers_shiv', section: 'Open World Rare Spawn', subgroup: 'Greywillow Vale - Brughol' },
  { itemId: 'gorraks_cruel_chopper', section: 'Open World Existing Rare/Boss', subgroup: 'Greywillow Vale - Brakka' },
  { itemId: 'mirejaw_biteblade', section: 'Open World Rare Spawn', subgroup: 'Sablefen - Mirejaw the Ravenous' },
  { itemId: 'mirejaw_scale_vest', section: 'Open World Rare Spawn', subgroup: 'Sablefen - Mirejaw the Ravenous' },
  { itemId: 'fen_reaver_glaive', section: 'Open World Rare Spawn', subgroup: 'Sablefen rare chase table' },
  { itemId: 'mirejaw_oracle_staff', section: 'Open World Rare Spawn', subgroup: 'Sablefen - Mirejaw the Ravenous' },
  { itemId: 'nhalias_dirgeblade', section: 'Open World Rare Spawn', subgroup: 'Sablefen rare chase table' },
  { itemId: 'broodmother_silk_robe', section: 'Open World Existing Rare/Boss', subgroup: 'Sablefen - The Broodmother' },
  { itemId: 'nhalias_funeral_wraps', section: 'Open World Rare Spawn', subgroup: 'Sablefen - Sister Nhalia' },
  { itemId: 'voss_sanctified_mace', section: 'Open World Existing Rare/Boss', subgroup: 'Sablefen - Deacon Drennan' },
  { itemId: 'ironvein_pickblade', section: 'Open World Rare Spawn', subgroup: 'Wardenwatch - Ironvein Foreman' },
  { itemId: 'ironvein_lantern_staff', section: 'Open World Rare Spawn', subgroup: 'Wardenwatch - Ironvein Foreman' },
  { itemId: 'drogmar_warboots', section: 'Open World Existing Rare/Boss', subgroup: 'Wardenwatch - Warlord Ghorbal' },
  { itemId: 'marrowlord_boneboots', section: 'Open World Rare Spawn', subgroup: 'Wardenwatch - Marrowlord Varkas' },
  { itemId: 'cryptbone_greaves', section: 'Dungeon - Hollow Crypt', subgroup: 'Sarghul' },
  { itemId: 'greyjaw_hide_boots', section: 'Dungeon - Hollow Crypt', subgroup: 'Sarghul' },
  { itemId: 'hollowbone_hauberk', section: 'Open World Rare Spawn', subgroup: 'Greywillow Vale - Elder Bristleback' },
  { itemId: 'gravewoven_raiment', section: 'Open World Rare Spawn', subgroup: 'Greywillow Vale - Sableweb Matriarch' },
  { itemId: 'cryptstalker_jerkin', section: 'Open World Rare Spawn', subgroup: 'Greywillow Vale - Brughol' },
  { itemId: 'hollowbound_legguards', section: 'Open World Rare Spawn', subgroup: 'Greywillow Vale - Elder Bristleback' },
  { itemId: 'gravepath_treads', section: 'Open World Rare Spawn', subgroup: 'Greywillow Vale - Sableweb Matriarch' },
  { itemId: 'tideguard_greaves', section: 'Dungeon - Sunken Bastion', subgroup: 'Theron rare armor table' },
  { itemId: 'tideguard_sabatons', section: 'Dungeon - Sunken Bastion', subgroup: 'Theron rare armor table' },
  { itemId: 'drowned_prayer_leggings', section: 'Dungeon - Sunken Bastion', subgroup: 'Ysra rare armor table' },
  { itemId: 'drowned_prayer_sandals', section: 'Dungeon - Sunken Bastion', subgroup: 'Ysra rare armor table' },
  { itemId: 'eelscale_leggings', section: 'Dungeon - Sunken Bastion', subgroup: 'Theron rare armor table' },
  { itemId: 'eelscale_treads', section: 'Dungeon - Sunken Bastion', subgroup: 'Ysra rare armor table' },
  { itemId: 'staff_of_velkhar', section: 'Dungeon - Wyrmbarrow Sanctum', subgroup: 'Durgath caster rare table' },
  { itemId: 'shadowmeld_tunic', section: 'Dungeon - Wyrmbarrow Sanctum', subgroup: 'Durgath agility rare table' },
  { itemId: 'wyrmcult_grand_robe', section: 'Dungeon - Wyrmbarrow Sanctum', subgroup: 'Durgath caster rare table' },
  { itemId: 'gravewyrm_sabatons', section: 'Dungeon - Wyrmbarrow Sanctum', subgroup: 'Durgath strength rare table' },
  { itemId: 'wyrmcult_soulsteps', section: 'Dungeon - Wyrmbarrow Sanctum', subgroup: 'Durgath caster rare table' },
  { itemId: 'gravewyrm_stalkers_treads', section: 'Dungeon - Wyrmbarrow Sanctum', subgroup: 'Nethanys rare armor table' },
  { itemId: 'deathlord_warplate', section: 'Dungeon - Wyrmbarrow Sanctum', subgroup: 'Vorruth epic armor table' },
  { itemId: 'necromancers_starshroud', section: 'Dungeon - Wyrmbarrow Sanctum', subgroup: 'Vorruth epic armor table' },
  { itemId: 'wyrmshadow_harness', section: 'Dungeon - Wyrmbarrow Sanctum', subgroup: 'Vorruth epic armor table' },
  { itemId: 'deathlord_legguards', section: 'Dungeon - Wyrmbarrow Sanctum', subgroup: 'Nethanys epic armor table' },
  { itemId: 'deathlord_sabatons', section: 'Open World Rare Spawn', subgroup: 'Wardenwatch - Ironvein Foreman' },
  { itemId: 'necromancers_soulsteps', section: 'Dungeon - Wyrmbarrow Sanctum', subgroup: 'Nethanys epic armor table' },
  { itemId: 'necromancers_legwraps', section: 'Open World Rare Spawn', subgroup: 'Wardenwatch - Marrowlord Varkas' },
  { itemId: 'wyrmshadow_treads', section: 'Dungeon - Wyrmbarrow Sanctum', subgroup: 'Durgath epic armor table' },
  { itemId: 'wyrmshadow_legguards', section: 'Dungeon - Wyrmbarrow Sanctum', subgroup: 'Nethanys epic armor table' },
];
