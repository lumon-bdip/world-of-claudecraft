...
// default (+10% rage); Guarded = Arms/Prot defensive (deal/take -10%, +30%
// threat); Berserker = Fury-only offensive default (+3% crit chance, +3% crit
// damage, no downside). Stances are mutually exclusive (exclusiveGroup
// 'warrior_stance') and auto-applied/reconciled each player-tick.
