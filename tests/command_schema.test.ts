...
const EXPECTED_SEND_COUNT = 125; // +Vale Cup queue/practice/sport-move commands
const EXPECTED_DISPATCH_COUNT = 134; // +Vale Cup queue/practice/sport-move commands
