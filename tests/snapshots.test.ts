...
// in the workstream, so we pin: (a) the exact registered key set against drift, (b) the// terse-key -> IWorld-name rename map, (c) that every dirtied value round-trips
