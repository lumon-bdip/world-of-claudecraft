...
// it lands the matching edit here in the SAME commit. The count pins (188 / 50 / 138)
...
// Partition: 50 `data` + 138 `method` (read-returning + command-void + async).
...
//   (4) their union, sorted, equals the pinned 188-name IWORLD_MEMBERS set (a member
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 23 facets', () => {
  ...
  it('the union of the 23 facets equals the pinned 188-member IWORLD_MEMBERS set', () => {
