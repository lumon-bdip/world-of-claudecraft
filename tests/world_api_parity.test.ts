...
//
// `IWorld` (src/world_api.ts, 234 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (234 / 62 / 172)
...
// The 234 members of `interface IWorld`, in interface order (world_api.ts).
// Partition: 62 `data` + 172 `method` (read-returning + command-void + async).
...
describe('IWORLD_MEMBERS is the pinned IWorld contract (anti-loosening)', () => {
  ...
  it('the full sorted member set is exactly the pinned 234', () => {
  ...
  it('the sorted method-kind set is exactly the pinned 172', () => {
...
//   (4) their union, sorted, equals the pinned 234-name IWORLD_MEMBERS set (a member
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 27 facets', () => {
  ...
  it('the union of the 27 facets equals the pinned 234-member IWORLD_MEMBERS set', () => {
