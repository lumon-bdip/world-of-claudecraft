...
//
// `IWorld` (src/world_api.ts, 182 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (182 / 50 / 132)
...
// Partition: 50 `data` + 132 `method` (read-returning + command-void + async).
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 22 facets', () => {
  ...
  it('the union of the 22 facets equals the pinned 182-member IWORLD_MEMBERS set', () => {
