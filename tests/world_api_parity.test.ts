...
//
// `IWorld` (src/world_api.ts:341-514, 151 members) is the ONE seam render/ui depend
...
// The 151 members of `interface IWorld`, in interface order (world_api.ts:342-513).
