...
const zhCnQuestNarratives = {
  ...
  q_wyrm_sigils: [`{playerName}，你该知道全貌了。唤骨者侍奉墓龙沃鲁斯，每个被偷走的灵魂都是倒入苏醒的贡品。带回3枚圣所徽记。`, `没错...一篇苏醒祷文，写了好几代。他们很近了，{playerName}。`],
...
const zhTwQuestNarratives = {
  ...
  q_wyrm_sigils: [`{playerName}，你該知道全貌了。喚骨者侍奉墓龍沃魯斯，每個被偷走的靈魂都是倒入甦醒的貢品。帶回3枚聖所徽記。`, `沒錯...一篇甦醒禱文，寫了好幾代。他們很近了，{playerName}。`],
...
const jaQuestNarratives = {
  ...
  q_wyrm_sigils: [`{playerName}、全てを知る時です。ボーンコーラーは墓ワームのヴォルースに仕え、盗んだ魂を目覚めの貢ぎ物にしています。印章を3つ持ってきてください。`, `はい...何世代も書かれた目覚めの連祷です。彼らは近い、{playerName}。`],
...
const zhCnData: LocaleData = {
  mobs: [
    ...
    '唤雾者伊斯拉', '圣所骨卫', '圣所龙人', '复生骨行者', '被缚者杜尔加斯', '大死灵法师内萨尼斯', '墓龙沃鲁斯',
  ],
  npcRows: [
  ...
  zones: [
    ...
    ['荆岭高地', '瓦莱里娅队长勉强守住卫望城墙。', ['卫望', '潜猎者山脊', '石塬洞穴', '食人魔山麓', '戈尔巴战争营地', '飓风岩', '粼光湖', '龙教帐篷', '亡魂战场', '墓龙圣所']],
  ],
  dungeons: [
...
const jaData: LocaleData = {
  mobs: [
    ...
    '聖所のドラコニッド', '甦った骨歩き', '縛られしダーガス', '大死霊術師ネサニス', '墓ワームのヴォルース',
  ],
  npcRows: [
  ...
  questTitles: [
    ...
    '下なる声', '聖所の門', '縛られた守護者', '大死霊術師', '墓ワームのヴォルース',
  ],
  objectiveItems: [
    ...
    'ヴェクスナーの心臓片', 'ワーム教団の命令書', '儀式の経箱', '墓ワームの印章', '祝福された残り火',
    '聖所の鍵片',
  ],
  zones: [
    ...
    ['ソーンフェル高地', 'ヴァレリア隊長がかろうじてウォーデンウォッチの壁を保っています。', ['ウォーデンウォッチ', '追跡者の尾根', 'ストーンリーチの巣穴', 'オーガの丘陵', 'ゴルバルの戦営', 'テンペストクラッグ', 'グリスターミア', 'ワーム教団の天幕', '亡霊の野', '墓ワームの聖所']],
  ],
  dungeons: [
