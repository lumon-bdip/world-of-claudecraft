...
const zhCnData: LocaleData = {
  mobs: [
    ...
    '泥沼潜伏兽', '黑湖钳咬鱼人', '泥沼寡妇蛛', '蛛母', '溺亡死者', '泥沼巨魔', '贪食者啮颚', '唤骨者教徒',
  ...
  objectiveItems: [
    ...
    '泥沼巨魔护符', '啮颚的獠牙', '唤骨者密文', '堡垒护符石', '卫望召令', '山脊潜猎者毛皮',
...
const zhTwData: LocaleData = {
  mobs: [
    ...
    '無情者布拉卡', '泥沼潛伏獸', '黑湖鉗咬魚人', '泥沼寡婦蛛', '蛛母', '溺亡死者', '泥沼巨魔',
  ...
  objectiveItems: [
    ...
    '浸水神像', '寡婦毒囊', '生鏽香爐', '泥沼巨魔護符', '嚙顎的獠牙', '喚骨者密文',
