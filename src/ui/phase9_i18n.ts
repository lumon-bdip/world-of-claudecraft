...
const esQuestNarratives = {
  ...
  q_fenbridge_muster: [`Los escritos de Sarghul nombran a un maestro en la ciénaga norte, {playerName}. Toma la orden de reunión en la puerta de Reedford y llévala al guardián.`, `¿El sello de Aldric? Servirás. La ciénaga se traga mis patrullas enteras.`],
  ...
  q_highwatch_summons: [`Las últimas palabras de Ysra no me dejan, {playerName}. Toma la citación de Wardenwatch y dile a Thessaly que Aldric sube tras de ti.`, `Si Aldric sube en persona, esto es tan grave como temía. Bienvenido a Wardenwatch, {playerName}.`],
  ...
  q_korgath: [`Maren halló cadenas gruesas como mástiles, {playerName}, y algo con forma de ogro tirando de ellas. Lleva cuatro compañeros y derriba a Durgath.`, `Durgath está roto al fin. Hasta sus cadenas merecían un final más amable.`],
...
const frQuestNarratives = {
  ...
  q_fenbridge_muster: [`Les écrits de Sarghul nomment un maître dans le marais du nord. Prenez l'ordre de rassemblement à Reedford, {playerName}, et présentez-le au gardien.`, `Le sceau d'Aldric? Alors vous ferez l'affaire. Le marais avale mes patrouilles entières.`],
  ...
  q_highwatch_summons: [`Les derniers mots de Ysra ne me quittent pas, {playerName}. Prenez la convocation de Wardenwatch et dites à Thessaly qu'Aldric monte derrière vous.`, `Si Aldric monte lui-même, c'est aussi grave que je le craignais. Bienvenue à Wardenwatch, {playerName}.`],
  ...
  q_korgath: [`Maren a trouvé des chaînes grosses comme des mâts, {playerName}, et une forme d'ogre qui tirait dessus. Prenez quatre compagnons et abattez Durgath.`, `Durgath est enfin brisé. Même ses chaînes méritaient une fin plus douce.`],
...
const deQuestNarratives = {
  ...
  q_highwatch_summons: [`Vaels letzte Worte lassen mich nicht los, {playerName}. Nimm die Einberufung von Wardenwatch und sag Thessaly, dass Aldric hinter dir aufsteigt.`, `Wenn Aldric selbst den Berg steigt, ist es so schlimm wie befürchtet. Willkommen in Wardenwatch, {playerName}.`],
  ...
  q_korgath: [`Maren fand Ketten dick wie Masten und etwas Ogerförmiges darin, {playerName}. Nimm vier Gefährten und bring Durgath zu Fall.`, `Durgath ist endlich gebrochen. Sogar seine Ketten verdienten ein freundlicheres Ende.`],
...
const itQuestNarratives = {
  ...
  q_fenbridge_muster: [`Gli scritti di Sarghul nominano un maestro nella palude del nord. Non credo alle coincidenze, {playerName}: prendi l'ordine di adunata al cancello di Reedford e consegnalo al custode.`, `Il sigillo di Aldric? Allora andrai bene. La palude inghiotte intere le mie pattuglie.`],
  ...
  q_highwatch_summons: [`Le ultime parole di Ysra non mi lasciano, {playerName}. Prendi la convocazione di Wardenwatch e dì a Thessaly che Aldric sale dietro di te.`, `Se Aldric sale di persona, è grave come temevo. Benvenuto a Wardenwatch, {playerName}.`],
  ...
  q_korgath: [`Maren ha trovato catene grosse come alberi di nave e qualcosa di forma ogre che tirava, {playerName}. Porta quattro compagni e abbatti Durgath.`, `Durgath è spezzato infine. Persino le sue catene meritavano una fine più gentile.`],
...
const ptQuestNarratives = {
  ...
  q_fenbridge_muster: [`Os escritos de Sarghul citam um mestre no pântano do norte, e eu não acredito em coincidências, {playerName}. Pegue a ordem de concentração no portão de Reedford e apresente-a ao guardião.`, `O selo de Aldric, é? Então você serve. O pântano engole minhas patrulhas inteiras.`],
  ...
  q_highwatch_summons: [`As últimas palavras de Ysra não me deixam, {playerName}. Pegue a convocação de Wardenwatch e diga a Thessaly que Aldric sobe atrás de você.`, `Se Aldric sobe em pessoa, é tão ruim quanto eu temia. Bem-vindo a Wardenwatch, {playerName}.`],
  ...
  q_korgath: [`Maren achou correntes grossas como mastros, {playerName}, e algo em forma de ogro puxando-as. Leve quatro companheiros e derrube Durgath.`, `Durgath está quebrado enfim. Até as correntes mereciam fim mais gentil.`],
...
const esData: LocaleData = {
  ...
  npcRows: [
    ...
    ['Guardián Fenwick', 'Guardián de Reedford', 'Alto en la puerta, {className}. Más allá de los juncos, la ciénaga mata por nosotros.'],
    ...
    ['Proveedor Hale', 'Proveedor', 'Botas secas, pan seco y pólvora seca: en Reedford consigues dos de tres en un buen día.'],
    ...
    ['Capitana Thessaly', 'Capitana de Wardenwatch', 'Doscientos años ha resistido este muro, {className}. No caerá bajo mi guardia, aunque gime.'],
    ...
    ['Intendente Bree', 'Intendente de Wardenwatch', 'Lana, galleta dura y botas herradas: Wardenwatch vive de las tres, y apenas tengo existencias.'],
  ...
  zones: [
    ['Valle de Greywillow', 'Busca al mariscal Redbrook en la ciudad: tiene trabajo para ti.', ['Greywillow', 'Senda de lobos', 'Prado de jabalíes', 'Lago Espejo', 'Tanglemoor', 'Mina de cobre', 'Campamento bandido', 'Capilla caída']],
    ['Ciénaga de Sablefen', 'Preséntate ante el guardián Fenwick en la puerta de Reedford.', ['Reedford', 'Juncos de merodeadores', 'Bajíos de Blackmere', 'Matorral de viudas', 'Capilla ahogada', 'Túmulos trol', 'Campamento Bonecaller', 'El Bastión Sumergido']],
    ['Alturas de Thornfell', 'La capitana Thessaly sostiene el muro de Wardenwatch a duras penas.', ['Wardenwatch', 'Cresta del acechador', 'Madrigueras Stonereach', 'Colinas ogro', 'Campamento de guerra de Ghorbal', 'Tempestcrag', 'El Glistermere', 'Tiendas del Culto del Wyrm', 'Campos de aparecidos', 'Santuario del Wyrmbarrow']],
  ],
  dungeons: [
...
const frData: LocaleData = {
  ...
  npcRows: [
    ...
    ['Gardien Fenwick', 'Gardien de Reedford', 'Halte à la porte, {className}. Au-delà des roseaux, la fange tue pour nous.'],
    ...
    ['Approvisionneur Hale', 'Fournisseur', 'Bottes sèches, pain sec, poudre sèche: à Reedford, deux sur trois est une bonne journée.'],
    ...
    ['Capitaine Thessaly', 'Capitaine de Wardenwatch', 'Ce mur tient depuis deux cents ans, {className}. Il ne cédera pas sous ma garde, mais il gémit.'],
    ...
    ['Quartier-maître Bree', 'Quartier-maître de Wardenwatch', 'Laine, biscuit dur et bottes ferrées: Wardenwatch vit de ces trois choses, et je manque de tout.'],
  ...
  zones: [
    ["Val de Greywillow", 'Trouvez le maréchal Redbrook en ville: il a du travail pour vous.', ['Greywillow', 'Piste des loups', 'Pré aux sangliers', 'Lac Miroir', 'Tanglemoor', 'Mine de cuivre', 'Camp des bandits', 'Chapelle tombée']],
    ['Marais de Sablefen', 'Présentez-vous au gardien Fenwick à la porte de Reedford.', ['Reedford', 'Roseaux des rôdeurs', 'Hauts-fonds de Blackmere', 'Fourré des veuves', 'Chapelle noyée', 'Tertres trolls', 'Campement Bonecaller', 'Le Bastion englouti']],
    ['Hauteurs de Thornfell', 'La capitaine Thessaly tient le mur de Wardenwatch, à peine.', ['Wardenwatch', 'Crête du traqueur', 'Terriers de Stonereach', 'Contreforts ogres', 'Camp de guerre de Ghorbal', 'Tempestcrag', 'Le Glistermere', 'Tentes du Culte du Wyrm', 'Champs des revenants', 'Sanctuaire du Wyrmbarrow']],
  ],
  dungeons: [
...
const deData: LocaleData = {
  ...
  npcRows: [
    ...
    ['Wärter Fenwick', 'Wärter von Reedford', 'Halt am Tor, {className}. Hinter dem Schilf tötet das Moor für uns.'],
    ...
    ['Proviantmeister Hale', 'Proviantmeister', 'Trockene Stiefel, trockenes Brot, trockenes Pulver: In Reedford bekommst du an guten Tagen zwei davon.'],
    ...
    ['Hauptmann Thessaly', 'Hauptmann von Wardenwatch', 'Zweihundert Jahre steht diese Mauer, {className}. Unter meiner Wache bricht sie nicht, auch wenn sie ächzt.'],
    ...
    ['Quartiermeisterin Bree', 'Quartiermeisterin von Wardenwatch', 'Wolle, Hartzwieback und beschlagene Stiefel: Wardenwatch lebt von allen dreien, und mir fehlt alles.'],
  ...
  zones: [
    ['Greywillow-Tal', 'Suche Marschall Redbrook in der Stadt: Er hat Arbeit für dich.', ['Greywillow', 'Wolfslauf', 'Eberwiese', 'Spiegelsee', 'Tanglemoor', 'Kupfermine', 'Banditenlager', 'Gefallene Kapelle']],
    ['Sablefen-Moor', 'Melde dich bei Wärter Fenwick am Tor von Reedford.', ['Reedford', 'Pirscher-Schilf', 'Blackmere-Untiefen', 'Witwendickicht', 'Ertrunkene Kapelle', 'Trollhügel', 'Bonecaller-Lager', 'Die versunkene Bastion']],
    ['Thornfell-Höhen', 'Hauptmann Thessaly hält die Mauer von Wardenwatch, gerade so.', ['Wardenwatch', 'Pirschergrat', 'Stonereach-Baue', 'Ogervorberge', 'Drogmars Kriegslager', 'Tempestcrag', 'Der Glistermere', 'Wyrmkult-Zelte', 'Wiedergängerfelder', 'Wyrmbarrow-Heiligtum']],
  ],
  dungeons: [
...
const itData: LocaleData = {
  ...
  npcRows: [
    ...
    ['Custode Fenwick', 'Custode di Reedford', 'Fermo al cancello, {className}. Oltre le canne, la palude uccide per noi.'],
    ...
    ['Provveditore Hale', 'Fornitore', 'Stivali asciutti, pane secco e polvere asciutta: a Reedford, due su tre è una buona giornata.'],
    ...
    ['Capitano Thessaly', 'Capitano di Wardenwatch', 'Questo muro resiste da duecento anni, {className}. Non cadrà sotto la mia guardia, anche se geme.'],
    ...
    ['Quartiermastro Bree', 'Quartiermastro di Wardenwatch', 'Lana, gallette dure e stivali ferrati: Wardenwatch vive di queste tre cose, e a me manca tutto.'],
  ...
  zones: [
    ['Valle di Greywillow', 'Cerca il maresciallo Redbrook in città: ha lavoro per te.', ['Greywillow', 'Sentiero dei lupi', 'Prato dei cinghiali', 'Lago Specchio', 'Tanglemoor', 'Miniera di rame', 'Campo dei banditi', 'Cappella caduta']],
    ['Palude di Sablefen', 'Presentati al custode Fenwick al cancello di Reedford.', ['Reedford', 'Canne dei predatori', 'Bassifondi di Blackmere', 'Folto delle vedove', 'Cappella annegata', 'Tumuli troll', 'Campo Bonecaller', 'Il Bastione Sommerso']],
    ['Alture di Thornfell', 'Il capitano Thessaly tiene a stento il muro di Wardenwatch.', ['Wardenwatch', 'Cresta del braccatore', 'Tane di Stonereach', 'Colline degli ogre', 'Campo di guerra di Ghorbal', 'Tempestcrag', 'Il Glistermere', 'Tende del Culto del Wyrm', 'Campi dei revenant', 'Santuario del Wyrmbarrow']],
  ],
  dungeons: [
...
const ptData: LocaleData = {
  ...
  npcRows: [
    ...
    ['Guardião Fenwick', 'Guardião de Reedford', 'Pare no portão, {className}. Além dos juncos, o pântano mata por nós.'],
    ...
    ['Fornecedor Hale', 'Fornecedor', 'Botas secas, pão seco e pólvora seca: em Reedford, dois de três já é um bom dia.'],
    ...
    ['Capitã Thessaly', 'Capitã de Wardenwatch', 'Este muro resiste há duzentos anos, {className}. Não cairá sob minha guarda, embora já gema.'],
    ...
    ['Intendente Bree', 'Intendente de Wardenwatch', 'Lã, biscoito duro e botas ferradas: Wardenwatch vive dessas três coisas, e estou sem tudo.'],
  ...
  zones: [
    ['Vale de Greywillow', 'Procure o marechal Redbrook na cidade: ele tem trabalho para você.', ['Greywillow', 'Trilha dos lobos', 'Campo dos javalis', 'Lago Espelho', 'Tanglemoor', 'Mina de cobre', 'Acampamento bandido', 'Capela caída']],
    ['Pântano de Sablefen', 'Apresente-se ao guardião Fenwick no portão de Reedford.', ['Reedford', 'Juncos dos espreitadores', 'Baixios de Blackmere', 'Matagal das viúvas', 'Capela afogada', 'Túmulos troll', 'Acampamento Bonecaller', 'O Bastião Submerso']],
    ['Alturas de Thornfell', 'A capitã Thessaly mal segura o muro de Wardenwatch.', ['Wardenwatch', 'Crista do rastreador', 'Tocas de Stonereach', 'Colinas ogro', 'Acampamento de guerra de Ghorbal', 'Tempestcrag', 'O Glistermere', 'Tendas do Culto do Wyrm', 'Campos de revenantes', 'Santuário do Wyrmbarrow']],
  ],
  dungeons: [
