...
const esQuestNarratives = {
  ...
  q_names_of_the_dead: [`Si los Gravecallers profanaron nuestras tumbas, necesito saber a quiénes robaron. Reúne 3 páginas del registro de entierros, {playerName}.`, `Pobres almas... y mira esto: el sacristán Marrow fue el primero. Morthen empezó con quien enterraba a Greywillow.`],
...
const frQuestNarratives = {
  ...
  q_names_of_the_dead: [`Si les Gravecallers ont pillé nos tombes, je dois savoir qui ils ont volé. Rassemblez 3 pages du registre funéraire, {playerName}.`, `Pauvres âmes... et voici le sacristain Marrow, le premier dérangé. Morthen a commencé par celui qui enterrait Greywillow.`],
...
const deQuestNarratives = {
  ...
  q_names_of_the_dead: [`Wenn die Gravecaller unsere Gräber raubten, muss ich wissen, wessen Ruhe sie stahlen. Sammle 3 Seiten des Begräbnisbuchs, {playerName}.`, `Arme Seelen... und sieh hier: Küster Marrow war der erste. Morthen begann mit dem Mann, der Greywillows Tote begrub.`],
...
const itQuestNarratives = {
  ...
  q_names_of_the_dead: [`Se i Gravecaller hanno profanato le tombe, devo sapere chi hanno rubato. Raccogli 3 pagine del registro funebre, {playerName}.`, `Povere anime... e guarda: il sagrestano Marrow fu il primo. Morthen cominciò dall'uomo che seppelliva Greywillow.`],
  ...
  q_idols: [`Gli uomini pesce stringono idoli dragati dal fondo come reliquie. Prendine 5 ai murloc di Blackmere.`, `Opera dei Gravecaller, più antica di Morthen. La setta cominciò qui, {playerName}.`],
...
const ptQuestNarratives = {
  ...
  q_names_of_the_dead: [`Se os Gravecallers roubaram nossos túmulos, preciso saber quem foi tomado. Reúna 3 páginas do registro funerário, {playerName}.`, `Pobres almas... e veja: o sacristão Marrow foi o primeiro. Morthen começou pelo homem que enterrava Greywillow.`],
  ...
  q_idols: [`Os homens-peixe agarram ídolos dragados do fundo como relíquias. Tome 5 dos murlocs de Blackmere.`, `Obra dos Gravecallers, mais antiga que Morthen. A seita começou aqui, {playerName}.`],
...
const esData: LocaleData = {
  mobs: [
    ...
    'La Madre de la nidada', 'Muerto ahogado', 'Trol de Sablefen', 'Grubjaw el Glotón', 'Cultista Gravecaller', 'Invocador Gravecaller',
  ...
  questTitles: [
    'Lobos a la puerta', 'El viejo lobo', 'Pieles de Bristleback', 'Amenaza de Tanglemoor', 'Problemas en el lago', 'Ratas en la mina',
  ...
  objectiveItems: [
    ...
    'Saco de veneno de viuda', 'Incensario oxidado', 'Fetiche trol de Sablefen', 'Colmillo de Grubjaw', 'Cifra Gravecaller',
  ...
  zones: [
    ...
    ['Ciénaga de Sablefen', 'Preséntate ante el guardián Fenwick en la puerta de Reedford.', ['Reedford', 'Juncos de merodeadores', 'Bajíos de Blackmere', 'Matorral de viudas', 'Capilla ahogada', 'Túmulos trol', 'Campamento Gravecaller', 'El Bastión Sumergido']],
    ['Alturas de Thornfell', 'La capitana Thessaly sostiene el muro de Wardenwatch a duras penas.', ['Wardenwatch', 'Cresta del acechador', 'Madrigueras Stonereach', 'Colinas ogro', 'Campamento de guerra de Drogmar', 'Tempestcrag', 'El Glistermere', 'Tiendas del Culto del Wyrm', 'Campos de aparecidos', 'Santuario del Gravewyrm']],
  ],
  dungeons: [
...
const frData: LocaleData = {
  mobs: [
    ...
    'La Mère des couvées', 'Mort noyé', 'Troll de Sablefen', 'Grubjaw le Glouton', 'Cultiste Gravecaller', 'Invocateur Gravecaller',
  ...
  questTitles: [
    'Des loups à la porte', 'Le vieux loup', 'Peaux de Bristleback', 'La menace de Tanglemoor', 'Troubles au lac', 'Des rats dans la mine',
    'Les morts sans repos', 'Fournitures volées', 'Murmures sous terre', 'Les noms des morts', "Faire taire l'appel", 'Le rite de lien',
    'Dans le Creux', 'La cloche du sacristain', 'La piste du Gravecaller', 'Bandits du Val', 'Le chef de bande', 'Rassemblement à Reedford',
  ...
  objectiveItems: [
    ...
    'Sac à venin de veuve', 'Encensoir rouillé', 'Fétiche troll de Sablefen', 'Défense de Grubjaw', 'Chiffre de Gravecaller',
  ...
  zones: [
    ...
    ['Marais de Sablefen', 'Présentez-vous au gardien Fenwick à la porte de Reedford.', ['Reedford', 'Roseaux des rôdeurs', 'Hauts-fonds de Blackmere', 'Fourré des veuves', 'Chapelle noyée', 'Tertres trolls', 'Campement Gravecaller', 'Le Bastion englouti']],
    ['Hauteurs de Thornfell', 'La capitaine Thessaly tient le mur de Wardenwatch, à peine.', ['Wardenwatch', 'Crête du traqueur', 'Terriers de Stonereach', 'Contreforts ogres', 'Camp de guerre de Drogmar', 'Tempestcrag', 'Le Glistermere', 'Tentes du Culte du Wyrm', 'Champs des revenants', 'Sanctuaire du Gravewyrm']],
  ],
  dungeons: [
...
const deData: LocaleData = {
  mobs: [
    ...
    'Die Brutmutter', 'Ertrunkener Toter', 'Sablefen-Troll', 'Grubjaw der Vielfraß', 'Gravecaller-Kultist', 'Gravecaller-Beschwörer',
  ...
  questTitles: [
    'Wölfe vor der Tür', 'Der alte Wolf', 'Bristleback-Häute', 'Bedrohung aus Tanglemoor', 'Ärger am See', 'Ratten in der Mine',
  ...
  objectiveItems: [
    'Zahn des alten Greyjaw', 'Borstige Eberhaut', 'Seidendrüse von Tanglemoor', 'Gestohlene Vorratskiste', 'Gravecaller-Siegel',
    ...
    'Sablefen-Trollfetisch', 'Grubjaws Hauer', 'Gravecaller-Chiffre', 'Bastion-Wachstein', 'Einberufung von Wardenwatch',
  ...
  zones: [
    ...
    ['Sablefen-Moor', 'Melde dich bei Wärter Fenwick am Tor von Reedford.', ['Reedford', 'Pirscher-Schilf', 'Blackmere-Untiefen', 'Witwendickicht', 'Ertrunkene Kapelle', 'Trollhügel', 'Gravecaller-Lager', 'Die versunkene Bastion']],
    ['Thornfell-Höhen', 'Hauptmann Thessaly hält die Mauer von Wardenwatch, gerade so.', ['Wardenwatch', 'Pirschergrat', 'Stonereach-Baue', 'Ogervorberge', 'Drogmars Kriegslager', 'Tempestcrag', 'Der Glistermere', 'Wyrmkult-Zelte', 'Wiedergängerfelder', 'Gravewyrm-Heiligtum']],
  ],
  dungeons: [
...
const itData: LocaleData = {
  mobs: [
    ...
    'Madre della covata', 'Morto annegato', 'Troll di Sablefen', 'Grubjaw il Goloso', 'Cultista Gravecaller', 'Evocatore Gravecaller',
  ...
  questTitles: [
    'Lupi alla porta', 'Il vecchio lupo', 'Pelli di Bristleback', 'La minaccia di Tanglemoor', 'Problemi al lago', 'Ratti nella miniera',
    'I morti inquieti', 'Scorte rubate', 'Sussurri nel sottosuolo', 'I nomi dei morti', 'Zittire il richiamo', 'Il rito del vincolo',
    'Nel Vuoto', 'La campana del sagrestano', 'La traccia del Gravecaller', 'Banditi della Valle', 'Il capo', 'Adunata a Reedford',
  ...
  objectiveItems: [
    ...
    'Cifrario Gravecaller', 'Pietra di guardia del Bastione', 'Convocazione di Wardenwatch', 'Pelle di braccatore della cresta',
  ...
  zones: [
    ...
    ['Palude di Sablefen', 'Presentati al custode Fenwick al cancello di Reedford.', ['Reedford', 'Canne dei predatori', 'Bassifondi di Blackmere', 'Folto delle vedove', 'Cappella annegata', 'Tumuli troll', 'Campo Gravecaller', 'Il Bastione Sommerso']],
    ['Alture di Thornfell', 'Il capitano Thessaly tiene a stento il muro di Wardenwatch.', ['Wardenwatch', 'Cresta del braccatore', 'Tane di Stonereach', 'Colline degli ogre', 'Campo di guerra di Drogmar', 'Tempestcrag', 'Il Glistermere', 'Tende del Culto del Wyrm', 'Campi dei revenant', 'Santuario del Gravewyrm']],
  ],
  dungeons: [
...
const ptData: LocaleData = {
  mobs: [
    ...
    'Mãe da ninhada', 'Morto afogado', 'Troll de Sablefen', 'Grubjaw o Glutão', 'Cultista Gravecaller', 'Invocador Gravecaller',
  ...
  questTitles: [
    'Lobos à porta', 'O velho lobo', 'Peles de Bristleback', 'A ameaça de Tanglemoor', 'Problemas no lago', 'Ratos na mina',
    ...
    'O Mistcaller', 'A guarda nos picos', 'Rastreadores na crista', 'O inverno chega a Wardenwatch', 'Problemas em Stonereach',
  ...
  objectiveItems: [
    ...
    'Bolsa de veneno de viúva', 'Incensário enferrujado', 'Fetiche troll de Sablefen', 'Presa de Grubjaw', 'Cifra Gravecaller',
  ...
  zones: [
    ...
    ['Pântano de Sablefen', 'Apresente-se ao guardião Fenwick no portão de Reedford.', ['Reedford', 'Juncos dos espreitadores', 'Baixios de Blackmere', 'Matagal das viúvas', 'Capela afogada', 'Túmulos troll', 'Acampamento Gravecaller', 'O Bastião Submerso']],
    ['Alturas de Thornfell', 'A capitã Thessaly mal segura o muro de Wardenwatch.', ['Wardenwatch', 'Crista do rastreador', 'Tocas de Stonereach', 'Colinas ogro', 'Acampamento de guerra de Drogmar', 'Tempestcrag', 'O Glistermere', 'Tendas do Culto do Wyrm', 'Campos de revenantes', 'Santuário do Gravewyrm']],
  ],
  dungeons: [
