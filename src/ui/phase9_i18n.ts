...
const esQuestNarratives = {
  ...
  q_names_of_the_dead: [`Si los Bonecallers profanaron nuestras tumbas, necesito saber a quiénes robaron. Reúne 3 páginas del registro de entierros, {playerName}.`, `Pobres almas... y mira esto: el sacristán Marrow fue el primero. Morthen empezó con quien enterraba a Greywillow.`],
  ...
  q_hollow: [`Morthen te espera en el fondo de la Cripta Hueca, rodeado de muertos de élite. Lleva cuatro compañeros y acaba con él.`, `El susurro cesó. Los muertos duermen, {playerName}, y Greywillow te debe cuanto tiene.`],
  ...
  q_gravecallers_trail: [`Morthen murió, pero su secta no gastaría un siglo de silencio en una sola capilla. Busca su grimorio entre las ruinas, {playerName}.`, `Morthen escribía a un "Fogcaller" en la ciénaga norte. La secta no está muerta, {playerName}; solo esperó.`],
  ...
  q_fenbridge_muster: [`Los escritos de Morthen nombran a un maestro en la ciénaga norte, {playerName}. Toma la orden de reunión en la puerta de Reedford y llévala al guardián.`, `¿El sello de Aldric? Servirás. La ciénaga se traga mis patrullas enteras.`],
  ...
  q_idols: [`Los hombres pez abrazan ídolos sacados del fondo como reliquias. Quítales 5, aunque no los entregarán de buena gana.`, `Obra de los Bonecallers, más antigua que Morthen. La secta empezó aquí, {playerName}.`],
  ...
  q_summoners: [`Los invocadores llaman a los ahogados como perros a un silbato. Silencia 8 y tráeme 4 cifras.`, `Cada cifra está refrendada por el diácono Voss y enviada al Fogcaller. El maestro de Morthen, {playerName}. Lo hemos encontrado.`],
  ...
  q_highwatch_summons: [`Las últimas palabras de Vael no me dejan, {playerName}. Toma la citación de Wardenwatch y dile a Thessaly que Aldric sube tras de ti.`, `Si Aldric sube en persona, esto es tan grave como temía. Bienvenido a Wardenwatch, {playerName}.`],
  ...
  q_drogmar: [`Drogmar tomó la moneda del Wyrmcult y juró los clanes al despertar de la montaña. Entra en su campamento y mátalo, {playerName}, por Wardenwatch.`, `Drogmar yace muerto en su propio campamento. Compraste un invierno para mi muralla, {playerName}.`],
  ...
  q_wyrm_sigils: [`Es hora de que sepas toda la verdad, {playerName}. Los Bonecallers sirven a Korzul el Wyrmbarrow, y cada alma robada alimenta su despertar. Tráeme 3 sigilos del acceso al Santuario.`, `Sí... una letanía de despertar escrita durante generaciones. Están cerca, {playerName}.`],
  ...
  q_velkhar: [`Velkhar, primer Bonecaller, tejió cada hilo y vierte almas robadas en el Wyrm. Acaba con él, {playerName}.`, `Velkhar ha muerto y el rito perdió la cabeza, pero el Wyrm ya no duerme.`],
...
const frQuestNarratives = {
  ...
  q_names_of_the_dead: [`Si les Bonecallers ont pillé nos tombes, je dois savoir qui ils ont volé. Rassemblez 3 pages du registre funéraire, {playerName}.`, `Pauvres âmes... et voici le sacristain Marrow, le premier dérangé. Morthen a commencé par celui qui enterrait Greywillow.`],
  ...
  q_hollow: [`Morthen attend au fond de la Crypte creuse, entouré des morts d'élite qu'il a relevés. Prenez quatre compagnons et mettez fin à tout cela.`, `Les murmures ont cessé. Les morts dorment, {playerName}, et Greywillow vous doit tout.`],
  ...
  q_gravecallers_trail: [`Morthen est mort, mais sa secte n'aurait pas attendu un siècle pour une seule chapelle. Cherchez son grimoire dans les ruines, {playerName}.`, `Morthen écrivait à un Fogcaller dans le marais du nord. La secte n'est pas morte, {playerName}; elle a patienté.`],
  ...
  q_fenbridge_muster: [`Les écrits de Morthen nomment un maître dans le marais du nord. Prenez l'ordre de rassemblement à Reedford, {playerName}, et présentez-le au gardien.`, `Le sceau d'Aldric? Alors vous ferez l'affaire. Le marais avale mes patrouilles entières.`],
  ...
  q_idols: [`Les hommes-poissons serrent des idoles remontées du fond comme des reliques. Prenez-en 5 aux happeurs.`, `Oeuvre de Bonecaller, plus ancienne que Morthen. La secte a commencé ici, {playerName}.`],
  ...
  q_summoners: [`Les invocateurs appellent les noyés comme des chiens au sifflet. Faites-en taire 8 et rapportez 4 chiffres.`, `Chaque chiffre porte le contreseing du diacre Voss et s'adresse au Fogcaller. Le maître de Morthen, {playerName}. Nous l'avons trouvé.`],
  ...
  q_highwatch_summons: [`Les derniers mots de Vael ne me quittent pas, {playerName}. Prenez la convocation de Wardenwatch et dites à Thessaly qu'Aldric monte derrière vous.`, `Si Aldric monte lui-même, c'est aussi grave que je le craignais. Bienvenue à Wardenwatch, {playerName}.`],
  ...
  q_drogmar: [`Drogmar a pris la monnaie du Wyrmcult et juré les clans au réveil de la montagne. Entrez dans son camp et tuez-le, {playerName}, pour Wardenwatch.`, `Drogmar est mort dans son propre camp. Vous avez acheté un hiver à mon mur, {playerName}.`],
  ...
  q_wyrm_sigils: [`Il est temps que tu saches tout, {playerName}. Les Bonecallers servent Korzul le Wyrmbarrow, et chaque âme volée nourrit son réveil. Rapportez 3 sigils de l'approche du Sanctuaire.`, `Oui... une litanie de réveil écrite sur des générations. Ils sont proches, {playerName}.`],
  ...
  q_velkhar: [`Velkhar, premier des Bonecallers, a tissé chaque fil et verse des âmes volées dans le Wyrm. Tuez-le, {playerName}.`, `Velkhar est mort et le rite n'a plus de tête, mais le Wyrm ne dort plus.`],
...
const deQuestNarratives = {
  ...
  q_names_of_the_dead: [`Wenn die Bonecaller unsere Gräber raubten, muss ich wissen, wessen Ruhe sie stahlen. Sammle 3 Seiten des Begräbnisbuchs, {playerName}.`, `Arme Seelen... und sieh hier: Küster Marrow war der erste. Morthen begann mit dem Mann, der Greywillows Tote begrub.`],
  ...
  q_hollow: [`Morthen wartet am Grund der Hohlen Gruft, umringt von den elitären Toten. Nimm vier Gefährten mit und beende ihn.`, `Das Flüstern ist verstummt. Die Toten schlafen, {playerName}, und Greywillow schuldet dir alles.`],
  ...
  q_gravecallers_trail: [`Morthen ist tot, doch seine Sekte verschwendet kein Jahrhundert des Schweigens an eine einzige Kapelle. Suche sein Grimoire in den Ruinen, {playerName}.`, `Morthen schrieb an einen Fogcaller im nördlichen Moor. Die Sekte ist nicht tot, {playerName}; sie war nur geduldig.`],
  ...
  q_idols: [`Die Fischmenschen klammern ausgebaggerte Götzen wie Heiligtümer. Nimm den Schnappern 5 davon ab.`, `Bonecaller-Werk, älter als Morthen. Die Sekte begann hier, {playerName}.`],
  ...
  q_summoners: [`Beschwörer rufen die Ertrunkenen wie Hunde zur Pfeife. Bring 8 zum Schweigen und hol 4 Chiffren.`, `Jede Chiffre ist von Diakon Voss gegengezeichnet und an den Fogcaller gerichtet. Morthens Meister, {playerName}. Wir haben ihn gefunden.`],
  ...
  q_drogmar: [`Drogmar nahm Wyrmkult-Gold und schwor die Clans dem Erwachen des Berges. Geh ins Kriegslager und töte ihn, {playerName}, für Wardenwatch.`, `Drogmar liegt tot im eigenen Lager. Du hast meiner Mauer einen Winter erkauft, {playerName}.`],
  ...
  q_wyrm_sigils: [`Es ist Zeit, dass du alles erfährst, {playerName}. Die Bonecaller dienen Korzul dem Wyrmbarrow, und jede gestohlene Seele nährt sein Erwachen. Bring mir 3 Siegel vom Zugang zum Heiligtum.`, `Ja... eine Wecklitanei, über Generationen geschrieben. Sie sind nah, {playerName}.`],
  ...
  q_velkhar: [`Velkhar, erster der Bonecaller, spann jeden Faden und gießt gestohlene Seelen in den Wyrm. Beende ihn, {playerName}.`, `Velkhar ist tot, und der Ritus ist kopflos. Doch der Wyrm schläft nicht mehr.`],
...
const itQuestNarratives = {
  ...
  q_names_of_the_dead: [`Se i Bonecaller hanno profanato le tombe, devo sapere chi hanno rubato. Raccogli 3 pagine del registro funebre, {playerName}.`, `Povere anime... e guarda: il sagrestano Marrow fu il primo. Morthen cominciò dall'uomo che seppelliva Greywillow.`],
  ...
  q_hollow: [`Morthen attende in fondo alla Cripta Vuota, circondato dai morti d'élite che ha rialzato. Porta quattro compagni e fermalo.`, `I sussurri sono cessati. I morti dormono, {playerName}, ed Greywillow ti deve tutto.`],
  ...
  q_gravecallers_trail: [`Morthen è morto, ma la sua setta non sprecò un secolo di silenzio per una sola cappella. Cerca il suo grimorio tra le rovine, {playerName}.`, `Morthen scriveva a un Fogcaller nella palude del nord. La setta non è morta, {playerName}; ha solo atteso.`],
  ...
  q_fenbridge_muster: [`Gli scritti di Morthen nominano un maestro nella palude del nord. Non credo alle coincidenze, {playerName}: prendi l'ordine di adunata al cancello di Reedford e consegnalo al custode.`, `Il sigillo di Aldric? Allora andrai bene. La palude inghiotte intere le mie pattuglie.`],
  ...
  q_idols: [`Gli uomini pesce stringono idoli dragati dal fondo come reliquie. Prendine 5 ai murloc di Blackmere.`, `Opera dei Bonecaller, più antica di Morthen. La setta cominciò qui, {playerName}.`],
  ...
  q_summoners: [`Gli evocatori richiamano gli annegati come cani al fischio. Zittiscine 8 e portami 4 cifrari.`, `Ogni cifrario è controfirmato dal diacono Voss e diretto al Fogcaller. Il maestro di Morthen, {playerName}. Lo abbiamo trovato.`],
  ...
  q_highwatch_summons: [`Le ultime parole di Vael non mi lasciano, {playerName}. Prendi la convocazione di Wardenwatch e dì a Thessaly che Aldric sale dietro di te.`, `Se Aldric sale di persona, è grave come temevo. Benvenuto a Wardenwatch, {playerName}.`],
  ...
  q_drogmar: [`Drogmar ha preso la moneta del Wyrmcult e giurato i clan al risveglio della montagna. Quando colpisce il suolo, {playerName}, non restargli vicino. Entra nel campo e uccidilo per Wardenwatch.`, `Drogmar giace morto nel suo campo. Hai comprato un inverno al mio muro, {playerName}.`],
  ...
  q_wyrm_sigils: [`È ora che tu sappia tutto, {playerName}. I Bonecaller servono Korzul il Wyrmbarrow, e ogni anima rubata alimenta il risveglio. Portami 3 sigilli dall'accesso al Santuario.`, `Sì... una litania del risveglio scritta per generazioni. Sono vicini, {playerName}.`],
  ...
  q_velkhar: [`Velkhar, primo dei Bonecaller, ha tessuto ogni filo e versa anime rubate nel Wyrm. Finiscilo, {playerName}.`, `Velkhar è morto e il rito è senza testa. Ma il Wyrm non dorme più.`],
...
const ptQuestNarratives = {
  ...
  q_names_of_the_dead: [`Se os Bonecallers roubaram nossos túmulos, preciso saber quem foi tomado. Reúna 3 páginas do registro funerário, {playerName}.`, `Pobres almas... e veja: o sacristão Marrow foi o primeiro. Morthen começou pelo homem que enterrava Greywillow.`],
  ...
  q_hollow: [`Morthen espera no fundo da Cripta Vazia, cercado pelos mortos de elite que ergueu. Leve quatro companheiros e acabe com ele.`, `Os sussurros pararam. Os mortos dormem, {playerName}, e Greywillow lhe deve tudo.`],
  ...
  q_gravecallers_trail: [`Morthen está morto, mas sua seita não gastaria um século de silêncio por uma só capela. Procure o grimório nas ruínas, {playerName}.`, `Morthen escrevia a um Fogcaller no brejo ao norte. A seita não morreu, {playerName}; apenas esperou.`],
  ...
  q_fenbridge_muster: [`Os escritos de Morthen citam um mestre no pântano do norte, e eu não acredito em coincidências, {playerName}. Pegue a ordem de concentração no portão de Reedford e apresente-a ao guardião.`, `O selo de Aldric, é? Então você serve. O pântano engole minhas patrulhas inteiras.`],
  ...
  q_idols: [`Os homens-peixe agarram ídolos dragados do fundo como relíquias. Tome 5 dos murlocs de Blackmere.`, `Obra dos Bonecallers, mais antiga que Morthen. A seita começou aqui, {playerName}.`],
  ...
  q_summoners: [`Os invocadores chamam os afogados como cães ao assobio. Silencie 8 e traga 4 cifras.`, `Cada cifra é contra-assinada pelo diácono Voss e endereçada ao Fogcaller. O mestre de Morthen, {playerName}. Encontramos o mestre.`],
  ...
  q_highwatch_summons: [`As últimas palavras de Vael não me deixam, {playerName}. Pegue a convocação de Wardenwatch e diga a Thessaly que Aldric sobe atrás de você.`, `Se Aldric sobe em pessoa, é tão ruim quanto eu temia. Bem-vindo a Wardenwatch, {playerName}.`],
  ...
  q_drogmar: [`Drogmar tomou a moeda do Wyrmcult e jurou os clãs ao despertar da montanha. Entre no acampamento e mate-o, {playerName}, por Wardenwatch.`, `Drogmar jaz morto no próprio campo. Você comprou um inverno para minha muralha, {playerName}.`],
  ...
  q_wyrm_sigils: [`É hora de você saber de tudo, {playerName}. Os Bonecallers servem Korzul, o Wyrmbarrow, e cada alma roubada alimenta seu despertar. Traga 3 sigilos da aproximação do Santuário.`, `Sim... uma ladainha de despertar escrita por gerações. Estão perto, {playerName}.`],
  ...
  q_velkhar: [`Velkhar, primeiro dos Bonecallers, teceu cada fio e despeja almas roubadas no Wyrm. Acabe com ele, {playerName}.`, `Velkhar morreu e o rito perdeu a cabeça. Mas o Wyrm já não dorme.`],
...
const esData: LocaleData = {
  mobs: [
    'Lobo del bosque', 'Viejo Greyjaw', 'Jabalí salvaje', 'Acechador de Tanglemoor', 'Merodeador Aletabarro', 'Excavador Rata de Túnel',
    'Bandido del Valle', 'Huesos inquietos', 'Gorrak el Despiadado', 'Merodeador del lodazal', 'Chasqueador de Blackmere', 'Viuda de Sablefen',
    'La Madre de la nidada', 'Muerto ahogado', 'Trol de Sablefen', 'Grubjaw el Glotón', 'Cultista Bonecaller', 'Invocador Bonecaller',
    'Diácono Voss', 'Acechador de la cresta', 'Tunelador de Deep Rock', 'Ogro de Thornfell', 'Triturador de Thornfell', 'Señor de la guerra Drogmar',
    'Elemental de Tempestcrag', 'Señor de fragmentos Kazzix', 'Fanático del Culto del Wyrm', 'Nigromante del Culto del Wyrm', 'Aparecido de hueso',
    'Tambaleante de la Cripta', 'Acólito del Hueco', 'Viuda Huesofrío', 'Sacristán Marrow', 'Morthen el Bonecaller', 'Aparecido del Bastión',
    'Acólito atado a la marea', 'Siervo ahogado', 'Caballero comandante Olen', 'Vael el Fogcaller', 'Guardahuesos del Santuario', 'Dracónido del Santuario',
    'Caminahuesos alzado', 'Korgath el Encadenado', 'Gran nigromante Velkhar', 'Korzul el Wyrmbarrow',
  ],
  npcRows: [
  ...
  questTitles: [
    ...
    'La voz de abajo', 'La puerta del Santuario', 'El guardián encadenado', 'El gran nigromante', 'Korzul el Wyrmbarrow',
  ],
  objectiveItems: [
    'Colmillo del viejo Greyjaw', 'Piel de jabalí erizada', 'Glándula de seda de Tanglemoor', 'Caja de suministros robada',
    'Sigilo de Bonecaller', 'Página de registro desgastada', 'Sebo bendito', 'Esencia fantasmal', 'Grimorio de Morthen',
    'Orden de reunión de Reedford', 'Piel de merodeador del lodazal', 'Mercancías de la caravana perdida', 'Ídolo empapado',
    'Saco de veneno de viuda', 'Incensario oxidado', 'Fetiche trol de Sablefen', 'Colmillo de Grubjaw', 'Cifra Bonecaller',
  ...
  zones: [
    ...
    ['Alturas de Thornfell', 'La capitana Thessaly sostiene el muro de Wardenwatch a duras penas.', ['Wardenwatch', 'Cresta del acechador', 'Madrigueras Stonereach', 'Colinas ogro', 'Campamento de guerra de Drogmar', 'Tempestcrag', 'El Glistermere', 'Tiendas del Culto del Wyrm', 'Campos de aparecidos', 'Santuario del Wyrmbarrow']],
  ],
  dungeons: [
...
const frData: LocaleData = {
  mobs: [
    'Loup des bois', 'Vieux Greyjaw', 'Sanglier sauvage', 'Rôdeur de Tanglemoor', 'Rôdeur Aileron-de-boue', 'Terrassier Rat des tunnels',
    'Bandit du Val', 'Ossements agités', "Gorrak l'Impitoyable", 'Rôdeur du bourbier', 'Happeur de Blackmere', 'Veuve de Sablefen',
    'La Mère des couvées', 'Mort noyé', 'Troll de Sablefen', 'Grubjaw le Glouton', 'Cultiste Bonecaller', 'Invocateur Bonecaller',
    'Diacre Voss', 'Traqueur de crête', 'Tunnelier de Stonereach', 'Ogre de Thornfell', 'Broyeur de Thornfell', 'Seigneur de guerre Drogmar',
    'Élémentaire de Tempestcrag', 'Seigneur des éclats Kazzix', 'Zélote du Culte du Wyrm', 'Nécromancien du Culte du Wyrm', "Revenant caparaçonné d'os",
    'Traînard de la crypte', 'Acolyte du Creux', 'Veuve Frissos', 'Sacristain Marrow', 'Morthen le Bonecaller', 'Revenant du Bastion',
    'Acolyte lié aux marées', 'Serviteur noyé', 'Chevalier-commandant Olen', 'Vael le Fogcaller', 'Garde-os du Sanctuaire', 'Drakonide du Sanctuaire',
    'Marche-os relevé', "Korgath l'Enchaîné", 'Grand nécromancien Velkhar', 'Korzul le Wyrmbarrow',
  ],
  npcRows: [
  ...
  questTitles: [
    ...
    "La voix d'en bas", 'La porte du Sanctuaire', 'Le gardien lié', 'Le grand nécromancien', 'Korzul le Wyrmbarrow',
  ],
  objectiveItems: [
    'Croc du vieux Greyjaw', 'Peau de sanglier hérissée', 'Glande de soie de Tanglemoor', 'Caisse de fournitures volée',
    'Sceau de Bonecaller', 'Page de registre usée', 'Suif béni', 'Essence spectrale', 'Grimoire de Morthen',
    'Ordre de rassemblement de Reedford', 'Peau de rôdeur du bourbier', 'Marchandises de la caravane perdue', 'Idole détrempée',
    'Sac à venin de veuve', 'Encensoir rouillé', 'Fétiche troll de Sablefen', 'Défense de Grubjaw', 'Chiffre de Bonecaller',
    'Pierre de garde du Bastion', 'Convocation de Wardenwatch', 'Peau de traqueur de crête', 'Cire luisante', 'Totem de guerre ogre',
    'Coeur de tempête', 'Éclat de coeur de Kazzix', 'Ordres du Culte du Wyrm', 'Phylactère rituel', 'Sceau du Wyrmbarrow',
  ...
  zones: [
    ...
    ['Hauteurs de Thornfell', 'La capitaine Thessaly tient le mur de Wardenwatch, à peine.', ['Wardenwatch', 'Crête du traqueur', 'Terriers de Stonereach', 'Contreforts ogres', 'Camp de guerre de Drogmar', 'Tempestcrag', 'Le Glistermere', 'Tentes du Culte du Wyrm', 'Champs des revenants', 'Sanctuaire du Wyrmbarrow']],
  ],
  dungeons: [
...
const deData: LocaleData = {
  mobs: [
    'Waldwolf', 'Alter Greyjaw', 'Wilder Eber', 'Tanglemoor-Lauerer', 'Schlammflossen-Schleicher', 'Tunnelratten-Gräber',
    'Talbandit', 'Ruhelose Knochen', 'Gorrak der Gnadenlose', 'Moorpirscher', 'Blackmere-Schnapper', 'Sablefen-Witwe',
    'Die Brutmutter', 'Ertrunkener Toter', 'Sablefen-Troll', 'Grubjaw der Vielfraß', 'Bonecaller-Kultist', 'Bonecaller-Beschwörer',
    'Diakon Voss', 'Gratpirscher', 'Stonereach-Tunnelgräber', 'Thornfell-Oger', 'Thornfell-Zermalmer', 'Kriegsherr Drogmar',
    'Tempestcrag-Elementar', 'Splitterlord Kazzix', 'Wyrmkult-Eiferer', 'Wyrmkult-Nekromant', 'Knochengepanzerter Wiedergänger',
    'Gruftschlurfer', 'Akolyth der Höhlung', 'Knochenkälte-Witwe', 'Küster Marrow', 'Morthen der Bonecaller', 'Bastion-Wiedergänger',
    'Gezeitengebundener Akolyth', 'Ertrunkener Knecht', 'Ritterkommandant Olen', 'Vael der Fogcaller', 'Heiligtums-Knochenwache',
    'Heiligtumsdrakonid', 'Erhobener Knochenläufer', 'Korgath der Gebundene', 'Großnekromant Velkhar', 'Korzul der Wyrmbarrow',
  ],
  npcRows: [
  ...
  questTitles: [
    ...
    'Das Tor des Heiligtums', 'Der gebundene Wächter', 'Der Großnekromant', 'Korzul der Wyrmbarrow',
  ],
  objectiveItems: [
    'Zahn des alten Greyjaw', 'Borstige Eberhaut', 'Seidendrüse von Tanglemoor', 'Gestohlene Vorratskiste', 'Bonecaller-Siegel',
...
const itData: LocaleData = {
  mobs: [
    'Lupo della foresta', 'Vecchio Greyjaw', 'Cinghiale selvatico', 'Predatore di Tanglemoor', 'Predatore Pinnalimo', 'Scavatore ratto di galleria',
    'Bandito della Valle', 'Ossa irrequiete', 'Gorrak lo Spietato', 'Predatore del pantano', 'Murloc di Blackmere', 'Vedova di Sablefen',
    'Madre della covata', 'Morto annegato', 'Troll di Sablefen', 'Grubjaw il Goloso', 'Cultista Bonecaller', 'Evocatore Bonecaller',
    'Diacono Voss', 'Braccatore della cresta', 'Coboldo di Stonereach', 'Ogre di Thornfell', 'Frantumatore ogre', 'Signore della guerra Drogmar',
    'Elementale di Tempestcrag', 'Signore dei frammenti Kazzix', 'Zelota del Culto del Wyrm', 'Negromante del Culto del Wyrm',
    'Revenant corazzato di ossa', 'Barcollante della cripta', 'Accolito del Vuoto', 'Vedova Freddosso', 'Sagrestano Marrow',
    'Morthen il Bonecaller', 'Revenant del Bastione', 'Accolito legato alla marea', 'Servo annegato', 'Cavaliere comandante Olen',
    'Vael il Fogcaller', 'Guardiano osseo del Santuario', 'Draconide del Santuario', 'Camminatore di ossa risorto',
    'Korgath il Vincolato', 'Grande negromante Velkhar', 'Korzul il Wyrmbarrow',
  ],
  npcRows: [
  ...
  questTitles: [
    ...
    'La porta del Santuario', 'Il guardiano vincolato', 'Il grande negromante', 'Korzul il Wyrmbarrow',
  ],
  objectiveItems: [
    'Zanna del vecchio Greyjaw', 'Pelle di cinghiale irsuta', 'Ghiandola di seta di Tanglemoor', 'Cassa di scorte rubata',
    'Sigillo Bonecaller', 'Pagina di registro consunta', 'Sego benedetto', 'Essenza spettrale', 'Grimorio di Morthen',
    'Ordine di adunata di Reedford', 'Pelle di predatore del pantano', 'Merci della carovana perduta', 'Idolo fradicio',
    'Sacca velenifera di vedova', 'Incensiere arrugginito', 'Feticcio troll di Sablefen', 'Zanna di Grubjaw',
  ...
  zones: [
    ...
    ['Alture di Thornfell', 'Il capitano Thessaly tiene a stento il muro di Wardenwatch.', ['Wardenwatch', 'Cresta del braccatore', 'Tane di Stonereach', 'Colline degli ogre', 'Campo di guerra di Drogmar', 'Tempestcrag', 'Il Glistermere', 'Tende del Culto del Wyrm', 'Campi dei revenant', 'Santuario del Wyrmbarrow']],
  ],
  dungeons: [
...
const ptData: LocaleData = {
  mobs: [
    'Lobo da floresta', 'Velho Greyjaw', 'Javali selvagem', 'Espreitador de Tanglemoor', 'Espreitador Barbatana-de-lodo', 'Escavador rato de túnel',
    'Bandido do Vale', 'Ossos inquietos', 'Gorrak o Impiedoso', 'Espreitador do brejo', 'Murloc de Blackmere', 'Viúva de Sablefen',
    'Mãe da ninhada', 'Morto afogado', 'Troll de Sablefen', 'Grubjaw o Glutão', 'Cultista Bonecaller', 'Invocador Bonecaller',
    'Diácono Voss', 'Rastreador da crista', 'Kobold de Stonereach', 'Ogro de Thornfell', 'Esmagador ogro', 'Senhor da guerra Drogmar',
    'Elemental de Tempestcrag', 'Senhor dos fragmentos Kazzix', 'Zelote do Culto do Wyrm', 'Necromante do Culto do Wyrm',
    'Revenante encouraçado de ossos', 'Cambaleante da cripta', 'Acólito do Vazio', 'Viúva Frio-osso', 'Sacristão Marrow',
    'Morthen o Bonecaller', 'Revenante do Bastião', 'Acólito preso à maré', 'Servo afogado', 'Cavaleiro-comandante Olen',
    'Vael o Fogcaller', 'Guarda-osso do Santuário', 'Draconídeo do Santuário', 'Andarilho de ossos erguido',
    'Korgath o Acorrentado', 'Grande necromante Velkhar', 'Korzul o Wyrmbarrow',
  ],
  npcRows: [
  ...
  objectiveItems: [
    'Presa do velho Greyjaw', 'Pele eriçada de javali', 'Glândula de seda de Tanglemoor', 'Caixa de suprimentos roubada',
    'Sigilo Bonecaller', 'Página de registro gasta', 'Sebo abençoado', 'Essência espectral', 'Grimório de Morthen',
    'Ordem de concentração de Reedford', 'Pele de espreitador do brejo', 'Mercadorias da caravana perdida', 'Ídolo encharcado',
    'Bolsa de veneno de viúva', 'Incensário enferrujado', 'Fetiche troll de Sablefen', 'Presa de Grubjaw', 'Cifra Bonecaller',
  ...
  zones: [
    ...
    ['Alturas de Thornfell', 'A capitã Thessaly mal segura o muro de Wardenwatch.', ['Wardenwatch', 'Crista do rastreador', 'Tocas de Stonereach', 'Colinas ogro', 'Acampamento de guerra de Drogmar', 'Tempestcrag', 'O Glistermere', 'Tendas do Culto do Wyrm', 'Campos de revenantes', 'Santuário do Wyrmbarrow']],
  ],
  dungeons: [
