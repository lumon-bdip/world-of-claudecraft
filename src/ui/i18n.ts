...
const phase1 = {
  en: {
    seo: {
      title: "Legends of Aldermoor: Classic-Style Web MMO",
      description: "Embark on an epic adventure in Legends of Aldermoor, a classic-style micro-MMO playable directly in your browser. Join a persistent shared realm, level up classes, and defeat enemies!",
      genre: "MMORPG",
    ...
    a11y: {
      ...
      githubProject: "Open the Legends of Aldermoor GitHub project",
      discordCommunity: "Join the Legends of Aldermoor Discord community",
      donateProject: "Donate to support Legends of Aldermoor",
    },
    loading: {
      world: "Loading world...",
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Open Legends of Aldermoor from the new Home Screen icon.",
      ...
      androidOpenStep: "Open Legends of Aldermoor from the new icon.",
    ...
    serverUnavailable: {
      title: "Legends of Aldermoor - Realm Unavailable",
      logoAlt: "Legends of Aldermoor",
      eyebrow: "Realm maintenance",
      heading: "The realm is temporarily unavailable.",
      body: "We are restarting the game service and expect Aldermoon to return shortly. This page will keep checking automatically.",
      status: "Back soon",
    },
  },
  es: {
    seo: {
      title: "Legends of Aldermoor: MMO web de estilo clásico",
      description: "Emprende una aventura épica en Legends of Aldermoor, un micro-MMO de estilo clásico que se juega directamente en el navegador. Entra a un reino compartido, sube de nivel y derrota enemigos.",
      genre: "MMORPG",
    ...
    a11y: {
      ...
      githubProject: "Abrir el proyecto de Legends of Aldermoor en GitHub",
      discordCommunity: "Unirse a la comunidad de Legends of Aldermoor en Discord",
      donateProject: "Donar para apoyar Legends of Aldermoor",
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Abre Legends of Aldermoor desde el nuevo icono de la pantalla de inicio.",
      ...
      androidOpenStep: "Abre Legends of Aldermoor desde el nuevo icono.",
    ...
    serverUnavailable: {
      title: "Legends of Aldermoor - Reino no disponible",
      logoAlt: "Legends of Aldermoor",
      eyebrow: "Mantenimiento del reino",
      heading: "El reino no está disponible temporalmente.",
      body: "Estamos reiniciando el servicio del juego y esperamos que Aldermoon vuelva pronto. Esta página seguirá comprobándolo automáticamente.",
  ...
  es_ES: {
    seo: {
      title: "Legends of Aldermoor: MMO web de estilo clásico",
      description: "Emprende una aventura épica en Legends of Aldermoor, un micro-MMO de estilo clásico jugable directamente en el navegador. Únete a un reino compartido, sube clases de nivel y derrota enemigos.",
      genre: "MMORPG",
      playMode: "Multijugador",
      applicationCategory: "Juego",
      operatingSystem: "Navegador web",
    ...
    a11y: {
      ...
      githubProject: "Abrir el proyecto Legends of Aldermoor en GitHub",
      discordCommunity: "Unirse a la comunidad de Legends of Aldermoor en Discord",
      donateProject: "Donar para apoyar Legends of Aldermoor",
    },
    loading: {
  ...
  fr_FR: {
    seo: {
      title: "Legends of Aldermoor: MMO web de style classique",
      description: "Partez pour une aventure épique dans Legends of Aldermoor, un micro-MMO au style classique jouable directement dans votre navigateur. Rejoignez un royaume persistant, progressez en classe et terrassez vos ennemis.",
      genre: "MMORPG",
    ...
    a11y: {
      ...
      githubProject: "Ouvrir le projet Legends of Aldermoor sur GitHub",
      discordCommunity: "Rejoindre la communauté Legends of Aldermoor sur Discord",
      donateProject: "Faire un don pour soutenir Legends of Aldermoor",
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Ouvrez Legends of Aldermoor depuis la nouvelle icône de l'écran d'accueil.",
      ...
      androidOpenStep: "Ouvrez Legends of Aldermoor depuis la nouvelle icône.",
    ...
    serverUnavailable: {
      title: "Legends of Aldermoor - Royaume indisponible",
      logoAlt: "Legends of Aldermoor",
      eyebrow: "Maintenance du royaume",
      heading: "Le royaume est temporairement indisponible.",
      body: "Nous redémarrons le service de jeu et Aldermoon devrait revenir bientôt. Cette page continuera de vérifier automatiquement.",
  ...
  fr_CA: {
    seo: {
      title: "Legends of Aldermoor: MMO Web de style classique",
      description: "Partez à l'aventure dans Legends of Aldermoor, un micro-MMO de style classique jouable directement dans votre navigateur. Rejoignez un royaume partagé, faites progresser vos classes et terrassez des ennemis.",
      genre: "MMORPG",
      playMode: "Multijoueur",
      applicationCategory: "Jeu",
      operatingSystem: "Navigateur Web",
    ...
    serverUnavailable: {
      ...
      eyebrow: "Maintenance du royaume",
      heading: "Le royaume est temporairement indisponible.",
      body: "Nous redémarrons le service de jeu et Aldermoon devrait revenir sous peu. Cette page continuera de vérifier automatiquement.",
  ...
  it_IT: {
    seo: {
      title: "Legends of Aldermoor: MMO web in stile classico",
      description: "Parti per un'avventura epica in Legends of Aldermoor, un micro-MMO in stile classico giocabile direttamente dal browser. Entra in un reame condiviso, fai crescere le classi e sconfiggi i nemici.",
      genre: "MMORPG",
    ...
    a11y: {
      ...
      githubProject: "Apri il progetto Legends of Aldermoor su GitHub",
      discordCommunity: "Entra nella community Discord di Legends of Aldermoor",
      donateProject: "Fai una donazione per sostenere Legends of Aldermoor",
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Apri Legends of Aldermoor dalla nuova icona nella schermata Home.",
      ...
      androidOpenStep: "Apri Legends of Aldermoor dalla nuova icona.",
    ...
    serverUnavailable: {
      title: "Legends of Aldermoor - Reame non disponibile",
      logoAlt: "Legends of Aldermoor",
      eyebrow: "Manutenzione del reame",
      heading: "Il reame è temporaneamente non disponibile.",
      body: "Stiamo riavviando il servizio di gioco e prevediamo che Aldermoon torni a breve. Questa pagina continuerà a controllare automaticamente.",
      status: "Torna presto",
    },
  },
  de_DE: {
    seo: {
      title: "Legends of Aldermoor: Klassisches Web-MMO",
      description: "Begib dich in Legends of Aldermoor auf ein episches Abenteuer, ein Micro-MMO im klassischen Stil direkt im Browser. Betritt einen gemeinsamen Realm, steigere Klassen und besiege Gegner.",
      genre: "MMORPG",
    ...
    a11y: {
      ...
      githubProject: "Legends of Aldermoor-Projekt auf GitHub öffnen",
      discordCommunity: "Der Legends of Aldermoor-Community auf Discord beitreten",
      donateProject: "Spenden, um Legends of Aldermoor zu unterstützen",
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Öffne Legends of Aldermoor über das neue Symbol auf dem Home-Bildschirm.",
      ...
      androidOpenStep: "Öffne Legends of Aldermoor über das neue Symbol.",
    ...
    serverUnavailable: {
      title: "Legends of Aldermoor - Realm nicht verfügbar",
      logoAlt: "Legends of Aldermoor",
      eyebrow: "Realmwartung",
      heading: "Der Realm ist vorübergehend nicht verfügbar.",
      body: "Wir starten den Spieldienst neu und erwarten, dass Aldermoon bald zurückkehrt. Diese Seite prüft automatisch weiter.",
      status: "Bald zurück",
    },
  },
  zh_CN: {
    seo: {
      title: "Legends of Aldermoor：经典风格网页 MMO",
      description: "在 Legends of Aldermoor 展开史诗冒险。这是一款可直接在浏览器中游玩的经典风格微型 MMO。加入持续共享的服务器，提升职业等级，击败敌人。",
      genre: "MMORPG",
      playMode: "多人游戏",
    ...
    a11y: {
      ...
      githubProject: "打开 Legends of Aldermoor 的 GitHub 项目",
      discordCommunity: "加入 Legends of Aldermoor 的 Discord 社区",
      donateProject: "捐赠支持 Legends of Aldermoor",
    },
    loading: {
      world: "正在加载世界...",
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "从新的主屏幕图标打开 Legends of Aldermoor。",
      ...
      androidOpenStep: "从新图标打开 Legends of Aldermoor。",
      otherStandaloneDetail: "请保持设备处于横屏全屏。",
      otherInstallDetail: "安装此页面或将其添加到主屏幕，以获得最佳移动端全屏体验。",
    },
    serverUnavailable: {
      title: "Legends of Aldermoor - 服务器不可用",
      logoAlt: "Legends of Aldermoor",
      eyebrow: "服务器维护",
      heading: "服务器暂时不可用。",
      body: "我们正在重启游戏服务，Aldermoon 应会很快恢复。此页面会自动继续检查。",
      status: "即将恢复",
    },
  },
  zh_TW: {
    seo: {
      title: "Legends of Aldermoor：經典風格網頁 MMO",
      description: "在 Legends of Aldermoor 展開史詩冒險。這是一款可直接在瀏覽器中遊玩的經典風格微型 MMO。加入持續共享的伺服器，提升職業等級並擊敗敵人。",
      genre: "MMORPG",
      playMode: "多人遊戲",
    ...
    a11y: {
      ...
      characterActions: "角色操作",
      githubProject: "開啟 Legends of Aldermoor 的 GitHub 專案",
      discordCommunity: "加入 Legends of Aldermoor 的 Discord 社群",
      donateProject: "捐贈支持 Legends of Aldermoor",
    },
    loading: {
      world: "正在載入世界...",
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "從新的主畫面圖示開啟 Legends of Aldermoor。",
      ...
      androidOpenStep: "從新圖示開啟 Legends of Aldermoor。",
      otherStandaloneDetail: "請保持裝置為橫向全螢幕。",
      otherInstallDetail: "安裝此頁面或將其加入主畫面，以獲得最佳行動裝置全螢幕體驗。",
    },
    serverUnavailable: {
      title: "Legends of Aldermoor - 伺服器不可用",
      logoAlt: "Legends of Aldermoor",
      eyebrow: "伺服器維護",
      heading: "伺服器暫時不可用。",
      body: "我們正在重新啟動遊戲服務，Aldermoon 應會很快恢復。此頁面會自動持續檢查。",
      status: "即將恢復",
    },
  },
  ko_KR: {
    seo: {
      title: "Legends of Aldermoor: 클래식 스타일 웹 MMO",
      description: "브라우저에서 바로 즐기는 클래식 스타일 마이크로 MMO, Legends of Aldermoor에서 장대한 모험을 시작하세요. 지속되는 공유 렐름에 접속해 직업을 성장시키고 적을 물리치세요.",
      genre: "MMORPG",
      playMode: "멀티플레이어",
    ...
    a11y: {
      ...
      githubProject: "GitHub에서 Legends of Aldermoor 프로젝트 열기",
      discordCommunity: "Legends of Aldermoor Discord 커뮤니티 참여",
      donateProject: "Legends of Aldermoor 후원하기",
    },
    loading: {
      world: "세계 불러오는 중...",
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "새 홈 화면 아이콘에서 Legends of Aldermoor를 여세요.",
      ...
      androidOpenStep: "새 아이콘에서 Legends of Aldermoor를 여세요.",
      otherStandaloneDetail: "기기를 가로 전체 화면으로 유지하세요.",
      otherInstallDetail: "최상의 모바일 전체 화면 경험을 위해 이 페이지를 설치하거나 홈 화면에 추가하세요.",
    },
    serverUnavailable: {
      title: "Legends of Aldermoor - 렐름 이용 불가",
      logoAlt: "Legends of Aldermoor",
      eyebrow: "렐름 점검",
      heading: "렐름을 일시적으로 이용할 수 없습니다.",
      body: "게임 서비스를 재시작하고 있으며 Aldermoon은 곧 돌아올 예정입니다. 이 페이지는 자동으로 계속 확인합니다.",
      status: "곧 돌아옵니다",
    },
  },
  ja_JP: {
    seo: {
      title: "Legends of Aldermoor: クラシック風Web MMO",
      description: "ブラウザで直接遊べるクラシック風マイクロMMO、Legends of Aldermoor で壮大な冒険に出ましょう。永続的な共有レルムに参加し、クラスを育て、敵を倒してください。",
      genre: "MMORPG",
      playMode: "マルチプレイヤー",
    ...
    a11y: {
      ...
      githubProject: "GitHubでLegends of Aldermoorプロジェクトを開く",
      discordCommunity: "Legends of AldermoorのDiscordコミュニティに参加",
      donateProject: "Legends of Aldermoorを支援するために寄付",
    },
    loading: {
      world: "世界を読み込み中...",
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "新しいホーム画面アイコンからLegends of Aldermoorを開きます。",
      ...
      androidOpenStep: "新しいアイコンからLegends of Aldermoorを開きます。",
      otherStandaloneDetail: "端末を横向き全画面に保ってください。",
      otherInstallDetail: "最高のモバイル全画面体験のため、このページをインストールするかホーム画面に追加してください。",
    },
    serverUnavailable: {
      title: "Legends of Aldermoor - レルム利用不可",
      logoAlt: "Legends of Aldermoor",
      eyebrow: "レルムメンテナンス",
      heading: "レルムは一時的に利用できません。",
      body: "ゲームサービスを再起動しています。Aldermoonはまもなく戻る予定です。このページは自動的に確認を続けます。",
      status: "まもなく復帰",
    },
  },
  pt_BR: {
    seo: {
      title: "Legends of Aldermoor: MMO web em estilo clássico",
      description: "Embarque em uma aventura épica em Legends of Aldermoor, um micro-MMO de estilo clássico jogável diretamente no navegador. Entre em um reino compartilhado, evolua classes e derrote inimigos.",
      genre: "MMORPG",
    ...
    a11y: {
      ...
      githubProject: "Abrir o projeto Legends of Aldermoor no GitHub",
      discordCommunity: "Entrar na comunidade Legends of Aldermoor no Discord",
      donateProject: "Doar para apoiar Legends of Aldermoor",
    },
    loading: {
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Abra Legends of Aldermoor pelo novo ícone na tela inicial.",
      ...
      androidOpenStep: "Abra Legends of Aldermoor pelo novo ícone.",
    ...
    serverUnavailable: {
      title: "Legends of Aldermoor - Reino indisponível",
      logoAlt: "Legends of Aldermoor",
      eyebrow: "Manutenção do reino",
      heading: "O reino está temporariamente indisponível.",
      body: "Estamos reiniciando o serviço do jogo e esperamos que Aldermoon volte em breve. Esta página continuará verificando automaticamente.",
      status: "Voltamos em breve",
    },
  },
  ru_RU: {
    seo: {
      title: "Legends of Aldermoor: веб-MMO в классическом стиле",
      description: "Отправьтесь в эпическое приключение в Legends of Aldermoor, микро-MMO в классическом стиле прямо в браузере. Присоединяйтесь к общему миру, развивайте классы и побеждайте врагов.",
      genre: "MMORPG",
    ...
    a11y: {
      ...
      githubProject: "Открыть проект Legends of Aldermoor на GitHub",
      discordCommunity: "Присоединиться к Discord-сообществу Legends of Aldermoor",
      donateProject: "Пожертвовать на поддержку Legends of Aldermoor",
    },
    loading: {
      world: "Загрузка мира...",
    ...
    mobilePreflight: {
      ...
      iosOpenStep: "Откройте Legends of Aldermoor через новый значок на домашнем экране.",
      ...
      androidOpenStep: "Откройте Legends of Aldermoor через новый значок.",
    ...
    serverUnavailable: {
      title: "Legends of Aldermoor - мир недоступен",
      logoAlt: "Legends of Aldermoor",
      eyebrow: "Технические работы",
      heading: "Мир временно недоступен.",
      body: "Мы перезапускаем игровой сервис и ожидаем, что Aldermoon скоро вернется. Эта страница продолжит проверку автоматически.",
  ...
  ru_RU: {
    entities: {
      abilities: abilityTranslations([
        ...
        ["regrowth", "Дреннантановление", "Исцеляет дружественную цель на {damage} и дополнительно в течение 21 сек."],
...
const phase8En = {
  ...
  entities: {
    ...
    items: itemTranslations([
      ...
      "Gravewalker Softboots", "Bristly Boar Hide", "Bonecaller's Sigil", "Blessed Tallow", "Ghostly Essence", "Tanglemoor Silk Gland", "Stolen Supply Crate",
      "Old Grimfang's Fang", "Weathered Ledger Page", "Sarghul's Grimoire", "Cracked Wolf Fang", "Red Bandana", "Tough Jerky", "Slimy Murloc Scale", "Tallow Candle",
      "Twitching Spider Leg", "Bone Fragments", "Linen Scrap", "Reedford Muster Order", "Mire Prowler Pelt", "Lost Caravan Goods", "Waterlogged Idol", "Widow Venom Sac",
      "Rusted Censer", "Sablefen Troll Fetish", "Gnashmaw's Tusk", "Bonecaller Cipher", "Bastion Ward Stone", "Deacon's Cleaver", "Staff of Drowned Prayers",
      "Mistbinder Kris", "Drownedguard Breastplate", "Fenmist Robe", "Eelskin Tunic", "Trollhide Leggings", "Marshstrider Boots", "Fogcaller's Edge", "Ysra's Mist-Staff",
      "Riptide Dirk", "Knight-Commander's Greaves", "Tidescale Vest", "Reedford Rye Loaf", "Marsh Mint Tea", "Smoked Sablefen Eel", "Silvermist Cordial", "Bogiron Mace",
      "Fenreed Staff", "Sablefen Skinner", "Bogiron Hauberk", "Marshcloth Robe", "Reedwoven Jerkin", "Fenwalker Boots", "Reedwoven Trousers", "Bogiron Nugget",
      "Soggy Moccasin", "Cracked Fetish", "Chipped Tusk", "Blackmere Pearl", "Wardenwatch Summons", "Ridge Stalker Pelt", "Glowing Wax", "Ogre War Totem", "Storm Core",
      "Vexnar's Heartshard", "Wyrmcult Orders", "Ritual Phylactery", "Wyrmbarrow Sigil", "Blessed Embers", "Sanctum Key Shard", "Ridgestalker Treads", "Boneplate Vest",
      "Revenant Silk Robe", "Nightwalk Jerkin", "Zealotsbane Blade", "Emberwood Staff", "Cultist Flayer", "Ghorbal's Skullcleaver", "Ogre Bonecharm Staff",
      "Gutripper Shiv", "Stormshard Leggings", "Durgath's Chainwraps", "Boneguard Breastplate", "Staff of Nethanys", "Shadowmeld Tunic", "Wyrmbarrow Scale Hauberk",
      "Wyrmcult Grand Robe", "Wyrmscale Jerkin", "Wyrmfang Greatblade", "Staff of the Wyrmbarrow", "Fang of Vorruth", "Wardenwatch Trail Hardtack", "Meltwater Flask",
      "Roast Mountain Goat", "Glacier Melt", "Wardenwatch Warblade", "Craghorn Staff", "Icevein Dirk", "Wardenwatch Breastplate", "Peakwool Robe", "Stalkerhide Jerkin",
  ...
  es: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Botas blandas del Caminante de Tumbas", "Piel erizada de jabalí", "Sigilo de Bonecaller", "Sebo bendito", "Esencia fantasmal", "Glándula de seda de Tanglemoor", "Cajón de suministros robado",
        "Colmillo del viejo Grimfang", "Página de libro mayor ajada", "Grimorio de Sarghul", "Colmillo de lobo quebrado", "Pañuelo rojo", "Cecina dura", "Escama viscosa de múrloc", "Vela de sebo",
        "Pata de araña crispada", "Fragmentos de hueso", "Retal de lino", "Orden de alistamiento de Reedford", "Piel de merodeador del pantano", "Bienes de la caravana perdida", "Ídolo empapado", "Saco de veneno de viuda",
        "Incensario oxidado", "Fetiche trol de Sablefen", "Colmillo de Gnashmaw", "Cifra de Bonecaller", "Piedra de guarda del Bastión", "Cuchilla del diácono", "Bastón de plegarias ahogadas",
        "Cris atanieblas", "Coraza de Guardia Ahogada", "Toga de niebla del pantano", "Túnica de piel de anguila", "Leotardos de piel de trol", "Botas Zancapantanos", "Filo de Fogcaller", "Bastón de niebla de Ysra",
        "Puñal de marejada", "Grebas del caballero comandante", "Chaleco de escama de marea", "Hogaza de centeno de Reedford", "Té de menta del pantano", "Anguila ahumada de Sablefen", "Cordial de Niebla Plateada", "Maza de hierro de ciénaga",
        "Bastón de caña del pantano", "Desollador de Sablefen", "Loriga de hierro de ciénaga", "Toga de paño de marisma", "Jubón tejido de juncos", "Botas Caminapantanos", "Pantalones tejidos de juncos", "Pepita de hierro de ciénaga",
        "Mocasín empapado", "Fetiche agrietado", "Colmillo astillado", "Perla de Blackmere", "Citación de Wardenwatch", "Piel de acechador de la cresta", "Cera resplandeciente", "Tótem de guerra ogro", "Núcleo de tormenta",
        "Fragmento del corazón de Vexnar", "Órdenes del Culto del Wyrm", "Filacteria ritual", "Sigilo del Wyrmbarrow", "Brasas benditas", "Fragmento de llave del santuario", "Botines Acechacrestas", "Chaleco de placas óseas",
        "Toga de seda de aparecido", "Jubón Caminanoche", "Hoja Azote de Fanáticos", "Bastón de madera de ascuas", "Desollador de cultista", "Partecráneos de Ghorbal", "Bastón de amuleto óseo ogro",
        "Navaja Desgarratripas", "Leotardos de fragmento de tormenta", "Envolturas de malla de Durgath", "Coraza Guardahuesos", "Bastón de Nethanys", "Túnica Fundesombra", "Loriga de escamas de Wyrmbarrow",
        "Gran toga del Culto del Wyrm", "Jubón de escamas de wyrm", "Gran hoja Colmillo de Wyrm", "Bastón del Wyrmbarrow", "Colmillo de Vorruth", "Galleta de viaje de Wardenwatch", "Frasco de agua de deshielo",
        "Cabra montesa asada", "Agua de glaciar", "Hoja de guerra de Wardenwatch", "Bastón de Cuernorroca", "Puñal Vena de Hielo", "Coraza de Wardenwatch", "Toga de lana de cumbre", "Jubón de piel de acechador",
  ...
  fr_FR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Bottes souples Marchetombe", "Peau hérissée de sanglier", "Sceau de Bonecaller", "Suif béni", "Essence spectrale", "Glande de soie de Tanglemoor", "Caisse de fournitures volée",
        "Croc du vieux Grimfang", "Page de registre usée", "Grimoire de Sarghul", "Croc de loup fendu", "Bandana rouge", "Viande séchée coriace", "Écaille de murloc visqueuse", "Chandelle de suif",
        "Patte d'araignée frémissante", "Fragments d'os", "Chute de lin", "Ordre de rassemblement de Reedford", "Peau de rôdeur du bourbier", "Marchandises de la caravane perdue", "Idole détrempée", "Sac à venin de veuve",
        "Encensoir rouillé", "Fétiche troll de Sablefen", "Défense de Gnashmaw", "Chiffre de Bonecaller", "Pierre de garde du Bastion", "Fendoir du diacre", "Bâton des prières noyées",
        "Kris Lie-brume", "Cuirasse Garde-noyé", "Robe de brume des marais", "Tunique en peau d'anguille", "Jambières en peau de troll", "Bottes Marchemarais", "Tranchant de Fogcaller", "Bâton de brume de Ysra",
        "Dague de contre-courant", "Grèves du chevalier-commandant", "Gilet en écailles de marée", "Pain de seigle de Reedford", "Thé à la menthe des marais", "Anguille fumée de Sablefen", "Cordial Brume-d'argent", "Masse en fer des tourbières",
        "Bâton de roseau du marais", "Écorcheur de Sablefen", "Haubert en fer des tourbières", "Robe de toile des marais", "Pourpoint tissé de roseaux", "Bottes Marchefen", "Pantalon tissé de roseaux", "Pépite de fer des tourbières",
        "Mocassin détrempé", "Fétiche fissuré", "Défense ébréchée", "Perle de Blackmere", "Convocation de Wardenwatch", "Peau de rôdeur de la crête", "Cire luisante", "Totem de guerre ogre", "Noyau de tempête",
        "Éclat de coeur de Vexnar", "Ordres du Culte du Wyrm", "Phylactère rituel", "Sceau du Wyrmbarrow", "Braises bénies", "Éclat de clé du sanctuaire", "Bottines Traquecrête", "Gilet de plaques d'os",
        "Robe de soie revenante", "Pourpoint Marche-nuit", "Lame Fléau-des-zélotes", "Bâton de bois de braise", "Écorcheur de cultiste", "Fend-crâne de Ghorbal", "Bâton charme-d'os ogre",
        "Surin Éventreur", "Jambières d'éclat de tempête", "Enveloppes de mailles de Durgath", "Cuirasse Garde-os", "Bâton de Nethanys", "Tunique Fondombre", "Haubert d'écailles de Wyrmbarrow",
        "Grande robe du Culte du Wyrm", "Pourpoint en écailles de wyrm", "Grande lame Croc-de-wyrm", "Bâton du Wyrmbarrow", "Croc de Vorruth", "Biscuit de route de Wardenwatch", "Flasque d'eau de fonte",
        "Chèvre de montagne rôtie", "Fonte de glacier", "Lame de guerre de Wardenwatch", "Bâton de corne-roche", "Dague Veine-de-glace", "Cuirasse de Wardenwatch", "Robe en laine des cimes", "Pourpoint en peau de rôdeur",
  ...
  it_IT: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Stivaletti morbidi del Camminatombe", "Pelle ispida di cinghiale", "Sigillo di Bonecaller", "Sego benedetto", "Essenza spettrale", "Ghiandola di seta di Tanglemoor", "Cassa di rifornimenti rubata",
        "Zanna del vecchio Grimfang", "Pagina di registro logora", "Grimorio di Sarghul", "Zanna di lupo incrinata", "Bandana rossa", "Carne secca dura", "Scaglia viscida di murloc", "Candela di sego",
        "Zampa di ragno fremente", "Frammenti d'osso", "Ritaglio di lino", "Ordine di raduno di Reedford", "Pelliccia di predatore del pantano", "Merci della carovana perduta", "Idolo zuppo", "Sacca di veleno di vedova",
        "Turibolo arrugginito", "Feticcio troll di Sablefen", "Zanna di Gnashmaw", "Cifrario di Bonecaller", "Pietra di guardia del Bastione", "Mannaia del diacono", "Bastone delle preghiere annegate",
        "Kris Leganebbia", "Corazza Guardia Annegata", "Veste di nebbia palustre", "Tunica di pelle d'anguilla", "Gambiere di pelle di troll", "Stivali Passapaludi", "Filo di Fogcaller", "Bastone di nebbia di Ysra",
        "Pugnale Marea", "Schinieri del comandante cavaliere", "Gilet Scagliamarea", "Pagnotta di segale di Reedford", "Tè alla menta di palude", "Anguilla affumicata di Sablefen", "Cordiale Nebbia d'Argento", "Mazza di ferro di palude",
        "Bastone di canna palustre", "Scuoiatore di Sablefen", "Usbergo di ferro di palude", "Veste di stoffa palustre", "Giaco intrecciato di canne", "Stivali Camminapaludi", "Pantaloni intrecciati di canne", "Pepita di ferro di palude",
        "Mocassino fradicio", "Feticcio incrinato", "Zanna scheggiata", "Perla di Blackmere", "Convocazione di Wardenwatch", "Pelliccia di predatore del crinale", "Cera luminosa", "Totem da guerra ogre", "Nucleo di tempesta",
        "Scheggia del cuore di Vexnar", "Ordini del Culto del Wyrm", "Filatterio rituale", "Sigillo del Wyrmbarrow", "Braci benedette", "Scheggia di chiave del santuario", "Calzari Inseguicrinale", "Gilet di piastre ossee",
        "Veste di seta revenant", "Giaco Camminanotte", "Lama Flagello degli Zeloti", "Bastone di legno ardente", "Scuoiatore cultista", "Spaccateschi di Ghorbal", "Bastone amuleto d'osso ogre",
        "Stiletto Sventraviscere", "Gambiere Scheggiatempesta", "Fasce di maglia di Durgath", "Corazza GuardiadiOssa", "Bastone di Nethanys", "Tunica Fondombra", "Usbergo di scaglie di Wyrmbarrow",
        "Grande veste del Culto del Wyrm", "Giaco di scaglie di wyrm", "Spadone Zanna di Wyrm", "Bastone del Wyrmbarrow", "Zanna di Vorruth", "Galletta da sentiero di Wardenwatch", "Fiasca di acqua di disgelo",
        "Capra di montagna arrosto", "Fusione glaciale", "Lama da guerra di Wardenwatch", "Bastone di Corno Roccioso", "Pugnale Venaghiaccio", "Corazza di Wardenwatch", "Veste di lana delle vette", "Giaco di pelle di predatore",
  ...
  de_DE: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Weiche Grabwandlerstiefel", "Borstige Eberhaut", "Bonecallers Siegel", "Gesegneter Talg", "Geisterhafte Essenz", "Seidendrüse von Tanglemoor", "Gestohlene Vorratskiste",
        "Zahn des alten Grimfang", "Verwitterte Buchseite", "Morthens Grimoire", "Gesprungener Wolfszahn", "Rotes Halstuch", "Zähes Dörrfleisch", "Schleimige Murlocschuppe", "Talgkerze",
        "Zuckendes Spinnenbein", "Knochenfragmente", "Leinenfetzen", "Musterungsbefehl von Reedford", "Balg eines Moorpirschers", "Waren der verlorenen Karawane", "Durchnässtes Götzenbild", "Witwengiftsack",
        "Rostiges Räuchergefäß", "Sablefen-Trollfetisch", "Grubjaws Hauer", "Bonecaller-Chiffre", "Bastion-Wachstein", "Beil des Diakons", "Stab ertrunkener Gebete",
        "Nebelbinder-Kris", "Brustplatte der Ertrunkenenwache", "Fenmist-Robe", "Aalhaut-Tunika", "Trollhautgamaschen", "Marschschreiterstiefel", "Fogcallers Schneide", "Vaels Nebelstab",
        "Springflutdolch", "Schienen des Ritterkommandanten", "Gezeitenpanzerweste", "Reedford-Roggenlaib", "Sumpfminztee", "Geräucherter Sablefen-Aal", "Silbernebel-Kordial", "Moor Eisenstreitkolben",
        "Fenreed-Stab", "Sablefen-Häuter", "Moor Eisenhalsberge", "Sumpftuchrobe", "Schilfgewobenes Wams", "Fenwandererstiefel", "Schilfgewobene Hose", "Moor Eisennugget",
        "Durchnässter Mokassin", "Rissiger Fetisch", "Angeschlagener Hauer", "Blackmere-Perle", "Einberufung von Wardenwatch", "Balg eines Gratpirschers", "Glühendes Wachs", "Ogerkriegstotem", "Sturmkern",
        "Vexnar' Herzsplitter", "Befehle des Wyrmkults", "Rituelles Seelengefäß", "Wyrmbarrow-Siegel", "Gesegnete Glut", "Heiligtums-Schlüsselsplitter", "Gratpirschertreter", "Knochenplattenweste",
        ...
        "Bauchreißer-Shiv", "Sturmsplittergamaschen", "Korgaths Kettenwickel", "Knochenwachtbrustplatte", "Stab von Nethanys", "Schattenverschmelzungstunika", "Wyrmbarrow-Schuppenhalsberge",
        "Große Robe des Wyrmkults", "Wyrmschuppenwams", "Wyrmzahn-Großklinge", "Stab des Wyrmbarrow", "Korzuls Fangzahn", "Wardenwatch-Reisezwieback", "Schmelzwasserflasche",
        "Gebratene Bergziege", "Gletscherschmelze", "Wardenwatch-Kriegsklinge", "Felshornstab", "Eisaderdolch", "Wardenwatch-Brustplatte", "Gipfelwollrobe", "Pirschhauttunika",
  ...
  zh_CN: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "厉牙毛皮护腿", "新烤面包", "清爽泉水", "烤野猪肉", "魔法泉水", "魔法矿泉水", "魔法气泡水",
        "灰柳武装剑", "青铜工艺钉锤", "溪谷雕肉刀", "山胡桃短杖", "灰柳链甲背心", "谷纺长袍", "鞣制皮甲",
        "钉底靴", "灰柳羊毛长裤", "唤骨者宽刃剑", "寡妇牙短匕", "空洞法杖", "踏髓长靴", "司事便鞋",
        "墓行者软靴", "硬鬃野猪皮", "唤骨者徽记", "祝福油脂", "幽魂精华", "缠林丝腺", "被盗补给箱",
        "老厉牙的尖牙", "风化账页", "萨格尔的魔典", "裂开的狼牙", "红色面巾", "硬肉干", "黏滑鱼人鳞片", "油脂蜡烛",
        "抽搐的蜘蛛腿", "骨头碎片", "亚麻碎布", "芦津集结令", "泥沼潜伏者毛皮", "遗失商队货物", "浸水神像", "寡妇毒囊",
        "生锈香炉", "黑沼巨魔护符", "啮颚的獠牙", "唤骨者密文", "堡垒护符石", "执事劈刀", "溺亡祈祷法杖",
        "缚雾短剑", "溺卫胸甲", "沼雾长袍", "鳗皮外套", "巨魔皮护腿", "沼行者长靴", "唤雾者之锋", "伊斯拉的雾杖",
        "激流短匕", "骑士指挥官胫甲", "潮鳞外衣", "芦津黑麦面包", "沼泽薄荷茶", "烟熏泥沼鳗", "银雾甜酒", "沼铁钉锤",
        "沼芦法杖", "泥沼剥皮刀", "沼铁锁甲", "沼布长袍", "芦织皮甲", "沼行靴", "芦织长裤", "沼铁矿块",
        "湿透的软鞋", "裂纹护符", "缺口獠牙", "黑湖珍珠", "卫望召令", "山脊潜伏者毛皮", "发光蜡块", "食人魔战争图腾", "风暴核心",
        "维克斯纳的心裂片", "龙教命令", "仪式护命匣", "龙冢徽记", "祝福余烬", "圣所钥匙碎片", "山脊追猎者便鞋", "骨板外衣",
        "亡魂丝袍", "夜行皮甲", "狂信者克星之刃", "烬木法杖", "邪教剥皮刀", "戈尔巴的碎颅斧", "食人魔骨符法杖",
        "开膛短刀", "风暴碎片护腿", "杜尔加斯链甲裹腿", "骨卫胸甲", "内萨尼斯法杖", "融影外套", "龙冢鳞锁甲",
        "龙教大长袍", "龙鳞皮甲", "龙牙巨刃", "龙冢法杖", "沃鲁斯之牙", "卫望行军硬饼", "融雪水瓶",
        "烤山羊", "冰川融水", "卫望战刃", "岩角法杖", "冰脉短匕", "卫望胸甲", "峰羊毛长袍", "潜猎者皮甲",
  ...
  zh_TW: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "厲牙毛皮護腿", "新烤麵包", "清爽泉水", "烤野豬肉", "魔法泉水", "魔法礦泉水", "魔法氣泡水",
        "灰柳武裝劍", "青銅工藝釘錘", "溪谷雕肉刀", "山胡桃短杖", "灰柳鎖甲背心", "谷紡長袍", "鞣製皮甲",
        "釘底靴", "灰柳羊毛長褲", "喚骨者寬刃劍", "寡婦牙短匕", "空洞法杖", "踏髓長靴", "司事便鞋",
        "墓行者軟靴", "硬鬃野豬皮", "喚骨者徽記", "祝福油脂", "幽魂精華", "纏林絲腺", "被盜補給箱",
        "老厲牙的尖牙", "風化帳頁", "薩格爾的魔典", "裂開的狼牙", "紅色面巾", "硬肉乾", "黏滑魚人鱗片", "油脂蠟燭",
        "抽搐的蜘蛛腿", "骨頭碎片", "亞麻碎布", "蘆津集結令", "泥沼潛伏者毛皮", "遺失商隊貨物", "浸水神像", "寡婦毒囊",
        "生鏽香爐", "黑沼巨魔護符", "嚙顎的獠牙", "喚骨者密文", "堡壘護符石", "執事劈刀", "溺亡祈禱法杖",
        "縛霧短劍", "溺衛胸甲", "沼霧長袍", "鰻皮外套", "巨魔皮護腿", "沼行者長靴", "喚霧者之鋒", "伊斯拉的霧杖",
        "激流短匕", "騎士指揮官脛甲", "潮鱗外衣", "蘆津黑麥麵包", "沼澤薄荷茶", "煙燻泥沼鰻", "銀霧甜酒", "沼鐵釘錘",
        "沼蘆法杖", "泥沼剝皮刀", "沼鐵鎖甲", "沼布長袍", "蘆織皮甲", "沼行靴", "蘆織長褲", "沼鐵礦塊",
        "濕透的軟鞋", "裂紋護符", "缺口獠牙", "黑湖珍珠", "衛望召令", "山脊潛伏者毛皮", "發光蠟塊", "巨魔戰爭圖騰", "風暴核心",
        "維克斯納的心裂片", "龍教命令", "儀式護命匣", "龍塚徽記", "祝福餘燼", "聖所鑰匙碎片", "山脊追獵者便鞋", "骨板外衣",
        "亡魂絲袍", "夜行皮甲", "狂信者剋星之刃", "燼木法杖", "邪教剝皮刀", "戈爾巴的碎顱斧", "巨魔骨符法杖",
        "開膛短刀", "風暴碎片護腿", "杜爾加斯鎖甲裹腿", "骨衛胸甲", "內薩尼斯法杖", "融影外套", "龍塚鱗鎖甲",
        "龍教大長袍", "龍鱗皮甲", "龍牙巨刃", "龍塚法杖", "沃魯斯之牙", "衛望行軍硬餅", "融雪水瓶",
        "烤山羊", "冰川融水", "衛望戰刃", "岩角法杖", "冰脈短匕", "衛望胸甲", "峰羊毛長袍", "潛獵者皮甲",
  ...
  ko_KR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "쏜웰 민병대 검", "계곡 견습생 지팡이", "날카로운 더크", "민병대 사슬조끼", "계곡직조 로브", "그림자바느질 웃옷", "기름먹인 가죽 장화", "누빈 바지",
        "그림팽의 털가죽 다리보호구", "갓 구운 빵", "상쾌한 샘물", "구운 멧돼지 고기", "창조된 샘물", "창조된 광천수", "창조된 탄산수",
        "그레이윌로우 무장검", "청동세공 철퇴", "계곡 조각칼", "히코리 짧은지팡이", "그레이윌로우 사슬조끼", "계곡방적 로브", "무두질한 가죽 웃옷",
        "징박은 장화", "그레이윌로우 양모 바지", "뼈부름 넓은날검", "과부송곳니 더크", "공허의 지팡이", "골수밟이 장화", "성구지기의 슬리퍼",
        "무덤걸음 부드러운장화", "억센 멧돼지 가죽", "뼈부름 인장", "축복받은 수지", "유령 정수", "탱글무어 비단샘", "도난당한 보급 상자",
        "늙은 그림팽의 송곳니", "풍화된 장부 페이지", "사르굴의 마법서", "갈라진 늑대 송곳니", "붉은 두건", "질긴 육포", "끈적한 멀록 비늘", "수지 양초",
        "꿈틀대는 거미 다리", "뼈 조각", "아마포 조각", "리드포드 소집 명령서", "수렁 배회자 가죽", "잃어버린 대상단 물품", "물먹은 우상", "과부 독주머니",
        "녹슨 향로", "세이블펜 트롤 부적", "내시모우의 엄니", "뼈부름 암호문", "요새 수호석", "부제의 도끼", "익사한 기도의 지팡이",
        "안개결속 크리스", "익사수호자 흉갑", "수렁안개 로브", "뱀장어가죽 튜닉", "트롤가죽 다리보호구", "늪지걸음 장화", "안개부름 칼날", "이스라의 안개지팡이",
        "역조 더크", "기사대장 경갑", "조수비늘 조끼", "리드포드 호밀빵", "늪박하 차", "훈제 세이블펜 장어", "은안개 코디얼", "늪철 철퇴",
        "펜갈대 지팡이", "세이블펜 무두칼", "늪철 갑옷", "늪천 로브", "갈대직조 웃옷", "펜걸음 장화", "갈대직조 바지", "늪철 덩이",
        "젖은 모카신", "금 간 부적", "이 빠진 엄니", "블랙미어 진주", "워든워치 소환장", "산등성이 추적자 가죽", "빛나는 밀랍", "오우거 전쟁 토템", "폭풍 핵",
        "벡스나르의 심장파편", "고룡교단 명령서", "의식 성물함", "고룡무덤 인장", "축복받은 불씨", "성소 열쇠 조각", "산등성이추적자 발보호구", "뼈판 조끼",
        "망령 비단 로브", "밤걸음 웃옷", "광신자파멸 검", "잿불나무 지팡이", "교단 무두칼", "고르발의 해골가르개", "오우거 뼈부적 지팡이",
        "내장가름 칼", "폭풍파편 다리보호구", "두르가스의 사슬싸개", "뼈수호 흉갑", "네사니스의 지팡이", "그림자녹임 튜닉", "고룡무덤 비늘갑옷",
        "고룡교단 대로브", "고룡비늘 웃옷", "고룡송곳니 대검", "고룡무덤의 지팡이", "보루스의 송곳니", "워든워치 여정 건빵", "눈녹은 물 플라스크",
        "구운 산양", "빙하 녹은물", "워든워치 전투검", "바위뿔 지팡이", "얼음맥 더크", "워든워치 흉갑", "봉우리양모 로브", "추적자가죽 웃옷",
  ...
  ja_JP: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "ソーンウェル民兵の刃", "谷の見習い杖", "鋭いダーク", "民兵の鎖帷子ベスト", "谷織りのローブ", "影縫いのジャーキン", "油を塗った革のブーツ", "キルトのズボン",
        "グリムファングの毛皮レギンス", "焼きたてのパン", "爽やかな泉の水", "焼いた猪肉", "召喚された泉の水", "召喚された鉱水", "召喚された発泡水",
        "グレイウィローの武装剣", "青銅細工のメイス", "谷の彫りナイフ", "ヒッコリーの短杖", "グレイウィローの鎖帷子ベスト", "谷紡ぎのローブ", "なめし革のジャーキン",
        "鋲打ちブーツ", "グレイウィローの羊毛ズボン", "ボーンコーラーの大刃", "ウィドウファングのダーク", "虚ろの杖", "髄踏みのブーツ", "墓守のスリッパ",
        "墓歩きの柔らかいブーツ", "剛毛猪の皮", "ボーンコーラーの印章", "祝福された獣脂", "幽霊のエッセンス", "タングルムーアの絹腺", "盗まれた補給箱",
        "老グリムファングの牙", "風化した帳簿のページ", "サルグルの魔導書", "割れた狼の牙", "赤いバンダナ", "硬い干し肉", "ぬめるマーロックの鱗", "獣脂のろうそく",
        "ぴくつく蜘蛛の脚", "骨の破片", "リネンの切れ端", "リードフォード召集令", "沼の徘徊者の毛皮", "失われた隊商の物資", "水浸しの偶像", "寡婦蜘蛛の毒嚢",
        "錆びた香炉", "セーブルフェン・トロルの護符", "ナッシュモウの牙", "ボーンコーラーの暗号", "砦の護り石", "助祭の肉切り", "溺れた祈りの杖",
        "霧縛りのクリス", "溺れ衛兵の胸当て", "沼霧のローブ", "ウナギ皮のチュニック", "トロル革のレギンス", "沼渡りのブーツ", "ミストコーラーの刃", "イスラの霧杖",
        "激流のダーク", "騎士司令官のグリーヴ", "潮鱗のベスト", "リードフォードのライ麦パン", "沼ミント茶", "燻製セーブルフェンうなぎ", "銀霧のコーディアル", "沼鉄のメイス",
        "フェンリードの杖", "セーブルフェンの皮剥ぎ刀", "沼鉄のホーバーク", "沼布のローブ", "葦織りのジャーキン", "フェンウォーカーのブーツ", "葦織りのズボン", "沼鉄の塊",
        "水浸しのモカシン", "ひび割れた護符", "欠けた牙", "ブラックミアの真珠", "ウォーデンウォッチ召喚状", "尾根の追跡者の毛皮", "光る蝋", "オーガ戦のトーテム", "嵐の核",
        "ヴェクスナーの心臓片", "ワーム教団の命令書", "儀式の経箱", "ワームバローの印章", "祝福された残り火", "聖所の鍵片", "尾根追跡者の靴", "骨板のベスト",
        "亡霊絹のローブ", "夜歩きのジャーキン", "狂信者討ちの刃", "熾き木の杖", "教団員の皮剥ぎ刀", "ゴルバルの頭蓋割り", "オーガ骨護符の杖",
        "腹裂きのシヴ", "嵐片のレギンス", "ダーガスの鎖巻き", "骨守りの胸当て", "ネサニスの杖", "影溶けのチュニック", "ワームバロー鱗のホーバーク",
        "ワーム教団の大ローブ", "ワーム鱗のジャーキン", "ワーム牙の大剣", "ワームバローの杖", "ヴォルースの牙", "ウォーデンウォッチの旅堅パン", "雪解け水のフラスコ",
        "焼き山羊肉", "氷河の融け水", "ウォーデンウォッチの戦刃", "岩角の杖", "氷脈のダーク", "ウォーデンウォッチの胸当て", "峰羊毛のローブ", "追跡者革のジャーキン",
  ...
  pt_BR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Botas macias do Andatumbas", "Pele eriçada de javali", "Sigilo de Bonecaller", "Sebo abençoado", "Essência espectral", "Glândula de seda de Tanglemoor", "Caixote de suprimentos roubado",
        "Presa do velho Grimfang", "Página de livro-caixa gasta", "Grimório de Sarghul", "Presa de lobo rachada", "Bandana vermelha", "Charque duro", "Escama viscosa de murloc", "Vela de sebo",
        "Perna de aranha trêmula", "Fragmentos de osso", "Retalho de linho", "Ordem de convocação de Reedford", "Pele de espreitador do brejo", "Mercadorias da caravana perdida", "Ídolo encharcado", "Bolsa de veneno de viúva",
        "Incensário enferrujado", "Fetiche troll de Sablefen", "Presa de Gnashmaw", "Cifra de Bonecaller", "Pedra de guarda do Bastião", "Cutelo do diácono", "Cajado das preces afogadas",
        "Kris Prendenévoa", "Peitoral da Guarda Afogada", "Veste de névoa do brejo", "Túnica de pele de enguia", "Perneiras de pele de troll", "Botas Passabrejo", "Gume de Fogcaller", "Cajado de névoa de Ysra",
        "Punhal da ressaca", "Grevas do cavaleiro-comandante", "Colete de escama de maré", "Pão de centeio de Reedford", "Chá de hortelã do brejo", "Enguia defumada de Sablefen", "Cordial Névoa Prateada", "Maça de ferro do brejo",
        "Cajado de junco do brejo", "Esfolador de Sablefen", "Cota de ferro do brejo", "Veste de pano do brejo", "Gibão tecido de junco", "Botas Caminhabrejo", "Calças tecidas de junco", "Pepita de ferro do brejo",
        "Mocassim encharcado", "Fetiche rachado", "Presa lascada", "Pérola de Blackmere", "Convocação de Wardenwatch", "Pele de espreitador da crista", "Cera brilhante", "Totem de guerra ogro", "Núcleo da tempestade",
        "Estilhaço do coração de Vexnar", "Ordens do Culto do Wyrm", "Filactério ritual", "Sigilo do Wyrmbarrow", "Brasas abençoadas", "Estilhaço da chave do santuário", "Sapatilhas Espreita-crista", "Colete de placas ósseas",
        "Veste de seda revenante", "Gibão Caminhanoite", "Lâmina Ruína dos Zelotes", "Cajado de madeira de brasa", "Esfolador cultista", "Rachacrânios de Ghorbal", "Cajado amuleto de osso ogro",
        "Faca Rasga-entranhas", "Perneiras de estilhaço de tempestade", "Envoltórios de malha de Durgath", "Peitoral Guardião dos Ossos", "Cajado de Nethanys", "Túnica Fundesombra", "Cota de escamas do Wyrmbarrow",
        "Grande veste do Culto do Wyrm", "Gibão de escamas de wyrm", "Grande lâmina Presa de Wyrm", "Cajado do Wyrmbarrow", "Presa de Vorruth", "Biscoito de trilha de Wardenwatch", "Frasco de água de degelo",
        "Cabra montesa assada", "Derretimento glacial", "Lâmina de guerra de Wardenwatch", "Cajado Chifre de Rocha", "Punhal Veiogelo", "Peitoral de Wardenwatch", "Veste de lã das alturas", "Gibão de pele de espreitador",
  ...
  ru_RU: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Клинок ополчения Торнвелла", "Посох ученика долины", "Острый кортик", "Кольчужный жилет ополчения", "Долиннотканая роба", "Куртка Теневого шва", "Промасленные кожаные сапоги", "Стеганые штаны",
        ...
        "Грейвиллоуский строевой меч", "Бронзовая булава", "Долинный разделочный нож", "Короткий посох из гикори", "Грейвиллоуский кольчужный жилет", "Долиннопрядная роба", "Куртка из дубленой кожи",
        "Подбитые гвоздями сапоги", "Грейвиллоуские шерстяные штаны", "Широкий клинок Костяного Зова", "Кортик Вдовьего Клыка", "Посох Пустоты", "Сапоги Костоступа", "Туфли пономаря",
        "Мягкие сапоги Могильного Скитальца", "Щетинистая кабанья шкура", "Сигил Костяного Зова", "Благословенное сало", "Призрачная эссенция", "Шелковая железа Танглмура", "Украденный ящик припасов",
        "Клык старого Гримфанга", "Выветренная страница книги учета", "Гримуар Саргула", "Треснувший волчий клык", "Красная бандана", "Жесткое вяленое мясо", "Слизистая чешуя мурлока", "Сальная свеча",
        "Дергающаяся нога паука", "Фрагменты костей", "Лоскут льна", "Приказ о сборе в Ридфорде", "Шкура болотного хищника", "Товары пропавшего каравана", "Размокший идол", "Ядовитый мешочек вдовы",
        "Ржавое кадило", "Фетиш тролля Сейблфена", "Клык Гнашмоу", "Шифр Костяного Зова", "Обереговый камень бастиона", "Тесак дьякона", "Посох утонувших молитв",
        ...
        "Кортик обратной волны", "Наголенники рыцаря-командора", "Жилет из приливной чешуи", "Ржаной каравай Ридфорда", "Болотный мятный чай", "Копченый мирефенский угорь", "Серебристо-туманный кордиал", "Болотножелезная булава",
        "Посох из болотного тростника", "Сейблфенский шкуродер", "Болотножелезный хауберк", "Роба из болотной ткани", "Тростниковый плетеный жакет", "Сапоги Болотоступа", "Тростниковые плетеные штаны", "Кусок болотного железа",
        "Промокший мокасин", "Треснувший фетиш", "Щербатый клык", "Жемчужина Блэкмира", "Призыв Варденвотча", "Шкура хребтового охотника", "Светящийся воск", "Боевой тотем огра", "Ядро бури",
        "Осколок сердца Вакснара", "Приказы Культа Вирма", "Ритуальная филактерия", "Сигил Курганного Вирма", "Благословенные угли", "Осколок ключа святилища", "Поступь Хребтового Охотника", "Костепластинчатый жилет",
        "Шелковая роба ревенанта", "Куртка Ночного Хода", "Клинок Гибель Фанатиков", "Посох из угольного дерева", "Шкуродер культиста", "Черепокол Гхорбала", "Посох огрского костяного оберега",
        "Шив Живодера", "Поножи бурелома", "Кольчужные обмотки Дургата", "Кираса Костяной стражи", "Посох Нетаниса", "Туника Слияния с Тенью", "Хауберк из чешуи Курганного Вирма",
        "Великая роба Культа Вирма", "Куртка из вирмовой чешуи", "Великий клинок Клык Вирма", "Посох Курганного Вирма", "Клык Воррута", "Походный сухарь Варденвотча", "Фляга талой воды",
        "Жареный горный козел", "Ледниковая талая вода", "Боевой клинок Варденвотча", "Посох Камнерога", "Кортик Ледяной Жилы", "Кираса Варденвотча", "Роба из горной шерсти", "Куртка из шкуры охотника",
...
const phase11PetHud = {
  ...
  ru_RU: {
    ...
    petTauntDesc: "Прикажите питомцу вступить в бой и применить Рык в радиусе действия. Дреннантановление 10 секунд.",
  ...
  ru_RU: {
    ...
    itemUi: {
      ...
      tooltip: {
        ...
        useHealingPotion: "Использование: мгновенно восстанавливает {amount} здоровья. Можно использовать в бою. Дреннантановление 1 мин.",
        useManaPotion: "Использование: мгновенно восстанавливает {amount} маны. Можно использовать в бою. Дреннантановление 1 мин.",
...
const phase11EntitiesEn = {
  items: phase11NameTranslations(PHASE11_ITEM_IDS, [
    "Thornhide Maul", "Broodmother's Silk Robe", "Cryptbone Greaves", "Cryptstalker Jerkin", "Deathlord Legguards", "Deathlord Sabatons",
    "Deathlord Warplate", "Ghorbal's Warboots", "Drowned Prayer Leggings", "Drowned Prayer Sandals", "Eelscale Leggings", "Eelscale Treads",
    "Fen Reaver Glaive", "Brakka's Cruel Chopper", "Gravepath Treads", "Gravewoven Raiment", "Wyrmbarrow Sabatons", "Wyrmbarrow Stalker's Treads",
    "Grimfang Hide Boots", "Hollowbone Hauberk", "Hollowbound Legguards", "Ironvein Lantern Staff", "Ironvein Pickblade", "Marrowlord Boneboots",
    "Minor Healing Potion", "Minor Mana Potion", "Mirejaw Biteblade", "Mirejaw Oracle Staff", "Mirejaw Scale Vest", "Brughol's Copper Cudgel",
    "Brughol's Shiv", "Brughol's Stomper Boots", "Necromancer's Legwraps", "Necromancer's Soulsteps", "Necromancer's Starshroud", "Nhalia's Dirgeblade",
    "Nhalia's Funeral Wraps", "Raw Mirror Trout", "Duskweb Slippers", "Simple Fishing Pole", "Tangled Weed", "Tideguard Greaves",
    "Tideguard Sabatons", "Valeborn Spellblade", "Drennan's Sanctified Mace", "Wyrmcult Soulsteps", "Wyrmshadow Harness", "Wyrmshadow Legguards",
    "Wyrmshadow Treads",
  ], 'item'),
  mobs: phase11NameTranslations(PHASE11_MOB_IDS, [
    "Elder Thornhide", "Ironvein Foreman", "Ironvein Sapper", "Marrowlord Varkas", "Mirejaw Frenzy", "Mirejaw the Ravenous",
    "Brughol", "Brughol Lackey", "Nhalia Mourner", "Duskweb Hatchling", "Duskweb Matriarch", "Sister Nhalia", "Varkas Boneguard",
    "Imp", "Voidwalker",
  ], 'mob'),
  quests: {
    q_mogger_tracks: {
      title: "Brughol's Trail",
      ...
      completion: "Those tracks are fresh and deep enough to hold rain. Brughol is no camp tale, {playerName} - and he is close.",
      objectives: { 0: { label: "Wild Boar driven from the trail" } },
    },
    q_mogger: {
      title: "Brughol Must Fall",
      ...
      completion: "Brughol is dead at last. Greywillow's fields are safer, and you leave the Vale with one more tale worth retelling.",
      objectives: { 0: { label: "Brughol slain" } },
    },
  },
};
...
const phase11Entities = {
  ...
  es: {
    items: phase11NameTranslations(PHASE11_ITEM_IDS, [
      "Maza Thornhide", "Toga de seda de la Madre de la nidada", "Grebas Huesocripta", "Jubón Acechacripta", "Guardapiernas del Señor de la Muerte", "Escarpes del Señor de la Muerte",
      "Placa de guerra del Señor de la Muerte", "Botas de guerra de Ghorbal", "Leotardos de Plegaria Ahogada", "Sandalias de Plegaria Ahogada", "Leotardos de escama de anguila", "Botines de escama de anguila",
      "Guja del Segador del pantano", "Tajadora cruel de Brakka", "Botines Caminotumba", "Vestidura Tejetumba", "Escarpes del Wyrmbarrow", "Botines de acechador del Wyrmbarrow",
      "Botas de pellejo de Grimfang", "Loriga Hueso Hueco", "Guardapiernas Ligahueco", "Bastón linterna de Vena de Hierro", "Hoja pico de Vena de Hierro", "Botas óseas del Señor de Médula",
      "Poción menor de sanación", "Poción menor de maná", "Hoja Mordisco de Mirejaw", "Bastón de oráculo de Mirejaw", "Chaleco de escamas de Mirejaw", "Garrote de cobre de Brughol",
      "Navaja de Brughol", "Botas pisoteadoras de Brughol", "Envolturas de piernas del nigromante", "Pisadas de alma del nigromante", "Velo estelar del nigromante", "Hoja de endecha de Nhalia",
      "Envolturas funerarias de Nhalia", "Trucha espejo cruda", "Zapatillas Duskweb", "Caña de pescar sencilla", "Hierba enredada", "Grebas Guardamarea",
      "Escarpes Guardamarea", "Hoja mágica Natavalle", "Maza santificada de Drennan", "Pisadas de alma del Culto del Wyrm", "Arnés Sombravermis", "Guardapiernas Sombravermis",
      "Botines Sombravermis",
    ], 'item'),
    mobs: phase11NameTranslations(PHASE11_MOB_IDS, [
      "Viejo Thornhide", "Capataz Vena de Hierro", "Zapador Vena de Hierro", "Señor de Médula Varkas", "Frenesí Mirejaw", "Mirejaw el Voraz",
      "Brughol", "Esbirro de Brughol", "Doliente de Nhalia", "Cría Duskweb", "Matriarca Duskweb", "Hermana Nhalia", "Guardahuesos de Varkas",
      "Diablillo", "Caminante del Vacío",
    ], 'mob'),
    quests: {
      q_mogger_tracks: {
        title: "El rastro de Brughol",
        text: "Antes de tomar el camino al norte, Greywillow tiene una última espina clavada: Brughol. La bestia pisotea el prado bajo y enloquece a los jabalíes. Limpia la zona de su rastro para que veamos dónde se esconde.",
        completion: "Esas huellas son recientes y bastante hondas para juntar lluvia. Brughol no es un cuento de campamento, {playerName}, y está cerca.",
        objectives: { 0: { label: "Jabalí salvaje expulsado del rastro" } },
      },
      q_mogger: {
        title: "Brughol debe caer",
        text: "Brughol ha partido carretas, aplastado cercas y matado tanto ganado como para vaciar medio Valle. No lo enfrentes a solas. Lleva dos compañeros fuertes al prado oriental y acaba con la bestia para siempre.",
        completion: "Brughol ha muerto por fin. Los campos de Greywillow son más seguros, y sales del Valle con otra historia digna de contarse.",
        objectives: { 0: { label: "Brughol abatido" } },
      },
    },
  },
  ...
  fr_FR: {
    items: phase11NameTranslations(PHASE11_ITEM_IDS, [
      "Maillet Thornhide", "Robe de soie de la Mère des couvées", "Grèves d'os de crypte", "Pourpoint du Traquecrypte", "Garde-jambes du Seigneur de mort", "Solerets du Seigneur de mort",
      "Harnois de guerre du Seigneur de mort", "Bottes de guerre de Ghorbal", "Jambières de prière noyée", "Sandales de prière noyée", "Jambières en écailles d'anguille", "Bottines en écailles d'anguille",
      "Glaive du faucheur des marais", "Tranchoir cruel de Brakka", "Bottines Sentetombe", "Habit tissé de tombe", "Solerets du Wyrmbarrow", "Bottines du traqueur de Wyrmbarrow",
      "Bottes en peau de Grimfang", "Haubert d'os creux", "Garde-jambes liés au Creux", "Bâton-lanterne de Veinefer", "Lame-pioche de Veinefer", "Bottes d'os du Seigneur de moelle",
      "Potion de soins mineure", "Potion de mana mineure", "Lame-morsure de Mirejaw", "Bâton d'oracle de Mirejaw", "Gilet d'écailles de Mirejaw", "Gourdin de cuivre de Brughol",
      "Surin de Brughol", "Bottes piétineuses de Brughol", "Jambières du nécromancien", "Pas-d'âme du nécromancien", "Voile étoilé du nécromancien", "Lame-funèbre de Nhalia",
      "Bandelettes funéraires de Nhalia", "Truite miroir crue", "Mules Duskweb", "Canne à pêche simple", "Herbe emmêlée", "Grèves Garde-marée",
      "Solerets Garde-marée", "Lame-sort née du Val", "Masse sanctifiée de Drennan", "Pas-d'âme du Culte du Wyrm", "Harnais Ombrewyrm", "Garde-jambes Ombrewyrm",
      "Bottines Ombrewyrm",
    ], 'item'),
    mobs: phase11NameTranslations(PHASE11_MOB_IDS, [
      "Ancien Thornhide", "Contremaître Veinefer", "Sapeur Veinefer", "Seigneur de moelle Varkas", "Frénésie Mirejaw", "Mirejaw l'Affamé",
      "Brughol", "Laquais de Brughol", "Pleureuse de Nhalia", "Jeune Duskweb", "Matriarche Duskweb", "Soeur Nhalia", "Garde-os de Varkas",
      "Diablotin", "Marcheur du Vide",
    ], 'mob'),
    quests: {
      q_mogger_tracks: {
        title: "La piste de Brughol",
        text: "Avant de prendre la route du nord, Greywillow a une dernière épine dans le pied : Brughol. La brute piétine le pré bas et rend les sangliers fous. Nettoyez le pré autour de sa piste pour que nous voyions où il se terre.",
        completion: "Ces traces sont fraîches et assez profondes pour retenir la pluie. Brughol n'est pas une histoire de camp, {playerName}, et il est proche.",
        objectives: { 0: { label: "Sanglier sauvage chassé de la piste" } },
      },
      q_mogger: {
        title: "Brughol doit tomber",
        text: "Brughol a brisé des chariots, aplati des clôtures et tué assez de bétail pour vider la moitié du Val. Ne l'affrontez pas seul. Emmenez deux compagnons solides au pré de l'est et abattez la brute pour de bon.",
        completion: "Brughol est enfin mort. Les champs de Greywillow sont plus sûrs, et vous quittez le Val avec une histoire de plus à raconter.",
        objectives: { 0: { label: "Brughol tué" } },
      },
    },
  },
  ...
  it_IT: {
    items: phase11NameTranslations(PHASE11_ITEM_IDS, [
      "Maglio Thornhide", "Veste di seta della Madre della covata", "Schinieri d'osso di cripta", "Giaco Braccacripta", "Gambiere del Signore della Morte", "Calzari del Signore della Morte",
      "Piastra da guerra del Signore della Morte", "Stivali da guerra di Ghorbal", "Gambiere della Preghiera Annegata", "Sandali della Preghiera Annegata", "Gambiere di scaglia d'anguilla", "Calzari di scaglia d'anguilla",
      "Falcione del Razziatore delle paludi", "Mannaia crudele di Brakka", "Calzari Sentierotomba", "Paramento Intessitomba", "Calzari del Wyrmbarrow", "Calzari del braccatore del Wyrmbarrow",
      "Stivali di pelle di Grimfang", "Usbergo d'osso cavo", "Gambiere Vincolovuoto", "Bastone lanterna di Venaferrata", "Lama-piccone di Venaferrata", "Stivali d'ossa del Signore del Midollo",
      "Pozione curativa minore", "Pozione di mana minore", "Lama del morso di Mirejaw", "Bastone dell'oracolo di Mirejaw", "Gilet di scaglie di Mirejaw", "Randello di rame di Brughol",
      "Coltello di Brughol", "Stivali pestatori di Brughol", "Fasce gambe del negromante", "Passi d'anima del negromante", "Velo stellare del negromante", "Lama del lamento di Nhalia",
      "Bende funebri di Nhalia", "Trota specchio cruda", "Pantofole Duskweb", "Canna da pesca semplice", "Erbaccia aggrovigliata", "Schinieri Guardiamarea",
      "Calzari Guardiamarea", "Lama magica Natavalle", "Mazza santificata di Drennan", "Passi d'anima del Culto del Wyrm", "Finimenti Ombrawyrm", "Gambiere Ombrawyrm",
      "Calzari Ombrawyrm",
    ], 'item'),
    mobs: phase11NameTranslations(PHASE11_MOB_IDS, [
      "Thornhide anziano", "Caposquadra Venaferrata", "Zappatore Venaferrata", "Signore del Midollo Varkas", "Furia Mirejaw", "Mirejaw il Famelico",
      "Brughol", "Lacchè di Brughol", "Piangente di Nhalia", "Piccolo Duskweb", "Matriarca Duskweb", "Sorella Nhalia", "Guardia d'ossa di Varkas",
      "Folletto", "Camminatore del Vuoto",
    ], 'mob'),
    quests: {
      q_mogger_tracks: {
        title: "La traccia di Brughol",
        text: "Prima di prendere la strada a nord, Greywillow ha un'ultima spina nel fianco: Brughol. Il bruto calpesta il prato basso e fa impazzire i cinghiali. Ripulisci il prato attorno alla sua traccia per scoprire dove si tana.",
        completion: "Quelle impronte sono fresche e abbastanza profonde da trattenere la pioggia. Brughol non è una storia da campo, {playerName}, ed è vicino.",
        objectives: { 0: { label: "Cinghiale selvatico scacciato dalla traccia" } },
      },
      q_mogger: {
        title: "Brughol deve cadere",
        text: "Brughol ha spaccato carri, schiacciato recinti e ucciso bestiame quanto basta per svuotare mezzo Valle. Non affrontarlo da solo. Porta due compagni forti nel prato orientale e abbatti il bruto per sempre.",
        completion: "Brughol è morto finalmente. I campi di Greywillow sono più sicuri, e lasci il Valle con un'altra storia da raccontare.",
        objectives: { 0: { label: "Brughol ucciso" } },
      },
    },
  },
  de_DE: {
    items: phase11NameTranslations(PHASE11_ITEM_IDS, [
      "Thornhide-Schlägel", "Seidenrobe der Brutmutter", "Gruftknochenbeinschienen", "Gruftpirscherwams", "Beinschützer des Todeslords", "Sabatons des Todeslords",
      ...
      "Moorhäscher-Gleve", "Gorraks grausamer Hackspalter", "Grabpfadtreter", "Grabgewobenes Gewand", "Wyrmbarrow-Sabatons", "Treter des Wyrmbarrow-Pirschers",
      "Grimfang-Balgstiefel", "Hohlknochenhalsberge", "Hohlgebundene Beinschützer", "Eisenader-Laternenstab", "Eisenader-Pickklinge", "Knochenstiefel des Marklords",
      ...
      "Nhalias Leichenwickel", "Rohe Spiegeltrutte", "Duskweb-Pantoffeln", "Einfache Angel", "Verheddertes Kraut", "Gezeitenwachtbeinschienen",
      "Gezeitenwachtsabatons", "Talgeborene Zauberklinge", "Drennan' geheiligter Streitkolben", "Seelenschritte des Wyrmkults", "Wyrmschattenharnisch", "Wyrmschattenbeinschützer",
      "Wyrmschattentreter",
    ], 'item'),
    mobs: phase11NameTranslations(PHASE11_MOB_IDS, [
      "Alter Thornhide", "Eisenader-Vorarbeiter", "Eisenader-Pionier", "Marklord Varkas", "Mirejaw-Raserei", "Mirejaw der Gefräßige",
      "Brughol", "Moggers Lakai", "Nhalia-Trauernde", "Duskweb-Jungtier", "Duskweb-Matriarchin", "Schwester Nhalia", "Varkas' Knochenwache",
      "Wichtel", "Leerwandler",
    ], 'mob'),
    quests: {
      q_mogger_tracks: {
        title: "Moggers Spur",
        text: "Bevor du die Straße nach Norden nimmst, hat Greywillow noch einen letzten Dorn im Fleisch: Brughol. Der Grobian zertrampelt die untere Wiese und treibt die Eber in den Wahnsinn. Säubere die Wiese um seine Spur, damit wir sehen, wo er haust.",
        completion: "Diese Spuren sind frisch und tief genug, um Regen zu halten. Brughol ist kein Lagerfeuermärchen, {playerName}, und er ist nah.",
        objectives: { 0: { label: "Wilder Eber von der Spur vertrieben" } },
      },
      q_mogger: {
        title: "Brughol muss fallen",
        text: "Brughol hat Karren gespalten, Zäune plattgewalzt und genug Vieh getötet, um das halbe Tal zu leeren. Stell dich ihm nicht allein. Nimm zwei starke Gefährten zur östlichen Wiese und leg den Grobian endgültig um.",
        completion: "Brughol ist endlich tot. Greywillows Felder sind sicherer, und du verlässt das Tal mit einer weiteren Geschichte, die es wert ist erzählt zu werden.",
        objectives: { 0: { label: "Brughol getötet" } },
      },
    },
  },
  zh_CN: {
    items: phase11NameTranslations(PHASE11_ITEM_IDS, [
      ...
      "死亡领主战甲", "戈尔巴的战靴", "溺祷护腿", "溺祷便鞋", "鳗鳞护腿", "鳗鳞足垫",
      "沼泽劫掠者长刃", "布拉卡的残酷斩斧", "墓径足垫", "墓织法衣", "龙冢护胫", "龙冢潜猎者足垫",
      "厉牙皮靴", "空骨锁甲", "缚空腿甲", "铁脉提灯法杖", "铁脉镐刃", "髓王骨靴",
      "初级治疗药水", "初级法力药水", "泥颚咬刃", "泥颚先知法杖", "泥颚鳞甲背心", "莫格的铜头短棒",
      "莫格的短刀", "莫格的践踏靴", "死灵法师腿缠", "死灵法师魂步", "死灵法师星幕", "娜莉娅的挽歌刃",
      "娜莉娅的葬缠", "生镜鳟鱼", "黑网便鞋", "简易鱼竿", "缠结水草", "潮卫护胫",
      "潮卫护靴", "谷裔法刃", "德伦南的圣化战锤", "龙教魂步", "龙影挽具", "龙影腿甲",
      "龙影足垫",
    ], 'item'),
    mobs: phase11NameTranslations(PHASE11_MOB_IDS, [
    ...
    quests: {
      q_mogger_tracks: {
        title: "莫格的踪迹",
        text: "在你踏上北路前，灰柳还有最后一根刺：莫格。那蛮兽践踏下方草地，把野猪都逼疯了。清理它踪迹周围的草地，我们才能看出它藏在哪里。",
      ...
      q_mogger: {
        ...
        completion: "莫格终于死了。灰柳的田地更安全了，而你离开谷地时又多了一个值得传颂的故事。",
  ...
  zh_TW: {
    items: phase11NameTranslations(PHASE11_ITEM_IDS, [
      ...
      "死亡領主戰甲", "戈爾巴的戰靴", "溺禱護腿", "溺禱便鞋", "鰻鱗護腿", "鰻鱗足墊",
      "沼澤劫掠者長刃", "布拉卡的殘酷斬斧", "墓徑足墊", "墓織法衣", "龍塚護脛", "龍塚潛獵者足墊",
      "厲牙皮靴", "空骨鎖甲", "縛空腿甲", "鐵脈提燈法杖", "鐵脈鎬刃", "髓王骨靴",
      "初級治療藥水", "初級法力藥水", "泥顎咬刃", "泥顎先知法杖", "泥顎鱗甲背心", "莫格的銅頭短棒",
      "莫格的短刀", "莫格的踐踏靴", "死靈法師腿纏", "死靈法師魂步", "死靈法師星幕", "娜莉亞的輓歌刃",
      "娜莉亞的葬纏", "生鏡鱒魚", "黑網便鞋", "簡易釣竿", "纏結水草", "潮衛護脛",
      "潮衛護靴", "谷裔法刃", "德倫南的聖化戰錘", "龍教魂步", "龍影挽具", "龍影腿甲",
      "龍影足墊",
    ], 'item'),
    mobs: phase11NameTranslations(PHASE11_MOB_IDS, [
    ...
    quests: {
      q_mogger_tracks: {
        title: "莫格的蹤跡",
        text: "在你踏上北路前，灰柳還有最後一根刺：莫格。那蠻獸踐踏下方草地，把野豬都逼瘋了。清理牠蹤跡周圍的草地，我們才能看出牠藏在哪裡。",
      ...
      q_mogger: {
        ...
        completion: "莫格終於死了。灰柳的田地更安全了，而你離開谷地時又多了一個值得傳頌的故事。",
  ...
  ko_KR: {
    items: phase11NameTranslations(PHASE11_ITEM_IDS, [
      ...
      "죽음군주 전쟁판금", "고르발의 전쟁장화", "익사한 기도 다리보호구", "익사한 기도 샌들", "뱀장어비늘 다리보호구", "뱀장어비늘 발보호구",
      "늪지 약탈자 글레이브", "고락의 잔혹 도끼", "무덤길 발보호구", "무덤직조 의복", "고룡무덤 쇠장화", "고룡무덤 추적자 발보호구",
      "그림팽 가죽 장화", "공허뼈 갑옷", "공허결속 다리보호구", "철맥 등불 지팡이", "철맥 곡괭이칼", "골수군주 뼈장화",
      ...
      "파도수호 쇠장화", "계곡태생 주문검", "드레난의 성화된 철퇴", "고룡교단 영혼걸음", "고룡그림자 멜빵", "고룡그림자 다리보호구",
      "고룡그림자 발보호구",
    ], 'item'),
    mobs: phase11NameTranslations(PHASE11_MOB_IDS, [
    ...
    quests: {
      q_mogger_tracks: {
        title: "모거의 흔적",
        text: "북쪽 길을 떠나기 전에 그레이윌로우에는 마지막 골칫거리, 모거가 남았습니다. 그 짐승은 아래 초원을 짓밟고 멧돼지를 미치게 합니다. 흔적 주변의 초원을 정리해 은신처를 찾아내십시오.",
      ...
      q_mogger: {
        ...
        completion: "마침내 모거가 죽었습니다. 그레이윌로우의 들판은 더 안전해졌고, 당신은 전할 만한 이야기를 하나 더 안고 계곡을 떠납니다.",
  ...
  ja_JP: {
    items: phase11NameTranslations(PHASE11_ITEM_IDS, [
      ...
      "死王の戦鎧", "ゴルバルの戦靴", "溺れし祈りのレギンス", "溺れし祈りのサンダル", "ウナギ鱗のレギンス", "ウナギ鱗の足具",
      "沼刈りのグレイブ", "ブラッカの残酷なチョッパー", "墓道の足具", "墓織りの衣", "グレイブワームのサバトン", "グレイブワーム追跡者の足具",
      "グリムファングの皮ブーツ", "虚ろ骨のホーバーク", "虚ろ縛りのレッグガード", "鉄脈のランタン杖", "鉄脈のつるはし刃", "髄王の骨ブーツ",
      ...
      "潮守りのサバトン", "谷生まれの呪文刃", "ドレナンの聖別メイス", "ワーム教団の魂歩き", "ワーム影のハーネス", "ワーム影のレッグガード",
      "ワーム影の足具",
    ], 'item'),
    mobs: phase11NameTranslations(PHASE11_MOB_IDS, [
    ...
    quests: {
      q_mogger_tracks: {
        title: "モガーの足跡",
        text: "北への道を進む前に、グレイウィローには最後の厄介者がいます。モガーです。あの巨獣は低い草地を踏み荒らし、猪を狂わせています。足跡の周囲を片付け、巣を見つけられるようにしてください。",
      ...
      q_mogger: {
        ...
        completion: "モガーはついに死にました。グレイウィローの畑は安全になり、あなたは語る価値のある物語をもう一つ抱えて谷を去ります。",
  ...
  pt_BR: {
    items: phase11NameTranslations(PHASE11_ITEM_IDS, [
      "Malho Thornhide", "Veste de seda da Mãe da ninhada", "Grevas Osso de Cripta", "Gibão Espreita-cripta", "Guarda-pernas do Senhor da Morte", "Escarpes do Senhor da Morte",
      "Placa de guerra do Senhor da Morte", "Botas de guerra de Ghorbal", "Perneiras de Prece Afogada", "Sandálias de Prece Afogada", "Perneiras de escama de enguia", "Pisantes de escama de enguia",
      "Glaive do Ceifador do brejo", "Cutelo cruel de Brakka", "Pisantes Caminho-túmulo", "Traje Tecetumba", "Escarpes do Wyrmbarrow", "Pisantes de espreitador do Wyrmbarrow",
      "Botas de couro de Grimfang", "Cota Osso Oco", "Guarda-pernas Vinculovazio", "Cajado lanterna de Veio de Ferro", "Lâmina-picareta de Veio de Ferro", "Botas ósseas do Senhor da Medula",
      "Poção menor de cura", "Poção menor de mana", "Lâmina Mordida de Mirejaw", "Cajado de oráculo de Mirejaw", "Colete de escamas de Mirejaw", "Porrete de cobre de Brughol",
      "Faca de Brughol", "Botas pisoteadoras de Brughol", "Envoltórios de perna do necromante", "Passos de alma do necromante", "Manto estelar do necromante", "Lâmina fúnebre de Nhalia",
      "Bandagens funerárias de Nhalia", "Truta-espelho crua", "Pantufas Duskweb", "Vara de pesca simples", "Erva emaranhada", "Grevas Guardamaré",
      "Escarpes Guardamaré", "Lâmina mágica Nascivale", "Maça santificada de Drennan", "Passos de alma do Culto do Wyrm", "Arnês Sombra de Wyrm", "Guarda-pernas Sombra de Wyrm",
      "Pisantes Sombra de Wyrm",
    ], 'item'),
    mobs: phase11NameTranslations(PHASE11_MOB_IDS, [
      "Thornhide ancião", "Capataz Veio de Ferro", "Sapador Veio de Ferro", "Senhor da Medula Varkas", "Frenesi Mirejaw", "Mirejaw, o Voraz",
      "Brughol", "Lacaio de Brughol", "Pranteadora de Nhalia", "Filhote Duskweb", "Matriarca Duskweb", "Irmã Nhalia", "Guardião dos ossos de Varkas",
      "Diabrete", "Caminhante do Vazio",
    ], 'mob'),
    quests: {
      q_mogger_tracks: {
        title: "A trilha de Brughol",
        text: "Antes de pegar a estrada ao norte, Greywillow tem um último espinho: Brughol. A fera pisoteia o prado baixo e enlouquece os javalis. Limpe o prado ao redor da trilha para descobrirmos onde ele se esconde.",
        completion: "Essas pegadas são recentes e fundas o bastante para segurar chuva. Brughol não é história de acampamento, {playerName}, e está perto.",
        objectives: { 0: { label: "Javali selvagem expulso da trilha" } },
      },
      q_mogger: {
        title: "Brughol deve cair",
        text: "Brughol partiu carroças, achatou cercas e matou gado suficiente para esvaziar metade do Vale. Não o enfrente só. Leve dois companheiros fortes ao prado leste e derrube a fera de vez.",
        completion: "Brughol está morto enfim. Os campos de Greywillow estão mais seguros, e você deixa o Vale com mais uma história digna de ser contada.",
        objectives: { 0: { label: "Brughol abatido" } },
      },
    },
  },
  ru_RU: {
    items: phase11NameTranslations(PHASE11_ITEM_IDS, [
      ...
      "Боевая латы Владыки Смерти", "Боевые сапоги Гхорбала", "Поножи Утопленной молитвы", "Сандалии Утопленной молитвы", "Поножи из угриной чешуи", "Ступни из угриной чешуи",
      "Глефа Болотного жнеца", "Жестокий тесак Бракки", "Ступни Могильной тропы", "Могильнотканое облачение", "Сабатоны Могильного вирма", "Ступни охотника Могильного вирма",
      ...
      "Сабатоны Стража прилива", "Долиннорожденный чароклинок", "Освященная булава Дреннана", "Шаги души Культа вирма", "Сбруя Тени вирма", "Поножи Тени вирма",
      "Ступни Тени вирма",
    ], 'item'),
    mobs: phase11NameTranslations(PHASE11_MOB_IDS, [
    ...
    quests: {
      q_mogger_tracks: {
        title: "След Моггера",
        text: "Прежде чем идти на северную дорогу, у Грейвиллоу осталась последняя заноза: Моггер. Зверь топчет нижний луг и сводит кабанов с ума. Очистите луг вокруг его следа, чтобы мы поняли, где он прячется.",
      ...
      q_mogger: {
        ...
        completion: "Моггер наконец мертв. Поля Грейвиллоу стали безопаснее, а вы покидаете долину с еще одной историей, достойной пересказа.",
...
const phase11ExtraEn = {
    ...
    mobs: phase11NameTranslations(DROWNED_MOB_IDS, [
      "Choirmother Selthe", "Drowned Templeguard", "Drowned Votary", "Glistermere Wader", "Glimmerscale Lurker", "Moonspawn", "Pale Choir Acolyte", "Pearlguard Sentinel", "Sethrael the Palecoil", "Fire Demon", "Void Demon", "Ysolei, Avatar of the Drowned Moon"
    ], 'drowned mob'),
    npcs: {
    ...
    quests: {
      ...
      q_tarn_waders: {
        ...
        objectives: { 0: { label: "Glistermere Wader slain" } },
      },
    },
    dungeons: {
...
const phase11Extra = {
  ...
  es: {
    ...
    mobs: phase11NameTranslations(DROWNED_MOB_IDS, [
      "Selthe, madre del coro", "Guardián ahogado del templo", "Devoto ahogado", "Vadeador de Glistermere", "Acechador de Escama Reluciente", "Engendro lunar", "Acólito del Coro Pálido", "Centinela de la Guardia de Perla", "Sethrael, la Espiral Pálida", "Demonio de fuego", "Demonio del vacío", "Ysolei, Avatar de la Luna Ahogada"
    ], 'drowned mob'),
    npcs: {
    ...
    quests: {
      ...
      q_tarn_waders: {
        ...
        objectives: { 0: { label: "Vadeador de Glistermere abatido" } },
      },
    },
    dungeons: {
  ...
  it_IT: {
    ...
    mobs: phase11NameTranslations(DROWNED_MOB_IDS, [
      "Selthe Madre del Coro", "Guardiano del Tempio Annegato", "Devoto Annegato", "Guadatore di Glistermere", "Acquattato di Glimmerscaglia", "Progenie Lunare", "Accolito del Coro Pallido", "Sentinella della Guardia di Perla", "Sethrael lo Spiropallido", "Demone di Fuoco", "Demone del Vuoto", "Ysolei, Avatar della Luna Annegata"
    ], 'drowned mob'),
    npcs: {
    ...
    quests: {
      ...
      q_tarn_waders: {
        ...
        text: "Da quando il cancello si è aperto, al crepuscolo cose risalgono dallo stagno — gonfie, pallide, con pinne là dove dovrebbero esserci le mani. Guadatori di Glistermere, li nominano i vecchi calchi. Trascinano giù con sé qualunque cosa viva. Abbattine dieci prima che riducano a nulla la mia veglia.",
        ...
        objectives: { 0: { label: "Guadatore di Glistermere ucciso" } },
      },
    },
    dungeons: {
  ...
  zh_TW: {
    ...
    mobs: phase11NameTranslations(DROWNED_MOB_IDS, [
      "唱詩之母瑟爾瑟", "溺亡神殿守衛", "溺亡信徒", "粼光湖涉者", "微鱗潛伏者", "月之裔", "蒼白唱詩侍僧", "珍珠衛哨兵", "蒼盤者賽斯瑞爾", "火焰惡魔", "虛空惡魔", "伊索蕾，溺月化身"
    ], 'drowned mob'),
    npcs: {
    ...
    quests: {
      ...
      q_tarn_waders: {
        title: "山湖吐還之物",
        text: "自那道門開啟以來，每逢黃昏便有東西自湖中爬出——腫脹、蒼白，本該是雙手的地方卻長著鰭。古老拓印稱牠們為粼光湖涉者。牠們會將任何活物拖回水底。在牠們把我的守望者損耗殆盡之前，剷除十隻。",
        completion: "十隻已回歸水中。牠們感受不到寒冷，{playerName}，也感受不到恐懼——只感受得到那道門的牽引。無論是什麼在向牠們歌唱，那歌聲都響亮得很。",
        objectives: { 0: { label: "粼光湖涉者已被擊殺" } },
      },
    },
    dungeons: {
  ...
  ko_KR: {
    ...
    mobs: phase11NameTranslations(DROWNED_MOB_IDS, [
      "성가대모 셀세", "익사한 신전 수호병", "익사한 신도", "글리스터미어 물거리", "반짝비늘 잠복자", "달의 부산물", "창백한 성가대 수습 사제", "진주수호 파수병", "페일코일의 세스라엘", "화염 악마", "공허 악마", "이솔레이, 익사한 달의 화신"
    ], 'drowned mob'),
    npcs: {
    ...
    quests: {
      ...
      q_tarn_waders: {
        title: "호수가 토해 내는 것",
        text: "관문이 열린 뒤로, 해 질 녘이면 무언가가 호수에서 기어 나온다네 — 퉁퉁 붓고 창백하며, 손이 있어야 할 자리에 지느러미가 달린 것들이지. 옛 탁본은 그것들을 글리스터미어 물거리라 부르네. 그것들은 살아 있는 것이라면 무엇이든 함께 물밑으로 끌고 들어가지. 내 경비가 모조리 사라지기 전에 열 마리를 솎아 내게.",
        completion: "열 마리를 물속으로 되돌려 보냈군. 그것들은 추위도, 두려움도 느끼지 못한다네, {playerName} — 오직 저 관문의 끌림만을 느낄 뿐이지. 무엇이 그것들에게 노래하든, 그 노래는 참으로 크게 울리는군.",
        objectives: { 0: { label: "글리스터미어 물거리 처치" } },
      },
    },
    dungeons: {
  ...
  pt_BR: {
    ...
    mobs: phase11NameTranslations(DROWNED_MOB_IDS, [
      "Mãe-do-Coro Selthe", "Guarda do Templo Afogado", "Devoto Afogado", "Vadeador de Glistermere", "Espreitador de Escama Reluzente", "Cria da Lua", "Acólito do Coro Pálido", "Sentinela da Guarda Pérola", "Sethrael, o Anel Pálido", "Demônio de Fogo", "Demônio do Vazio", "Ysolei, Avatar da Lua Afogada"
    ], 'drowned mob'),
    npcs: {
    ...
    quests: {
      ...
      q_tarn_waders: {
        ...
        text: "Desde que o portão se abriu, coisas sobem do lago ao anoitecer — inchadas, pálidas, com barbatanas onde deveria haver mãos. Vadeadores de Glistermere, é como os antigos decalques os nomeiam. Eles arrastam tudo o que vive de volta para o fundo consigo. Abata dez antes que reduzam minha vigília a nada.",
...
export const en = {
  ...
  footer: {
    copyright: "2026 Legends of Aldermoor",
  ...
  classes: {
    ...
    warlock: "Doomweaver",
    druid: "Wildshaper",
    warriorAria: "Warden class",
    paladinAria: "Lightsworn class",
    hunterAria: "Ranger class",
    rogueAria: "Shadowblade class",
    priestAria: "Cleric class",
    shamanAria: "Spiritcaller class",
    mageAria: "Arcanist class",
    warlockAria: "Doomweaver class",
    druidAria: "Wildshaper class",
  },
  controls: {
...
export const es: typeof en = {
  ...
  classes: {
    ...
    rogue: "Hoja Sombría",
    priest: "Clérigo",
    shaman: "Invocaespíritus",
    mage: "Arcanista",
    warlock: "Tejedor de Fatalidad",
    druid: "Cambiaformas Salvaje",
    warriorAria: "Clase Guardián",
    paladinAria: "Clase Juramentado",
    hunterAria: "Clase Montaraz",
    rogueAria: "Clase Hoja Sombría",
    priestAria: "Clase Clérigo",
    shamanAria: "Clase Invocaespíritus",
    mageAria: "Clase Arcanista",
    warlockAria: "Clase Tejedor de Fatalidad",
    druidAria: "Clase Cambiaformas Salvaje",
  },
  controls: {
...
export const fr_FR: typeof en = {
  ...
  classes: {
    ...
    paladin: "Assermenté",
    hunter: "Rôdeur",
    rogue: "Lame de l’Ombre",
    priest: "Clerc",
    shaman: "Évocateur d’Esprits",
    mage: "Arcaniste",
    warlock: "Tisseur de Damnation",
    druid: "Métamorphe Sauvage",
    warriorAria: "Classe Gardien",
    paladinAria: "Classe Assermenté",
    hunterAria: "Classe Rôdeur",
    rogueAria: "Classe Lame de l’Ombre",
    priestAria: "Classe Clerc",
    shamanAria: "Classe Évocateur d’Esprits",
    mageAria: "Classe Arcaniste",
    warlockAria: "Classe Tisseur de Damnation",
    druidAria: "Classe Métamorphe Sauvage",
  },
  controls: {
...
export const it_IT: typeof en = {
  ...
  classes: {
    ...
    shaman: "Evocaspiriti",
    mage: "Arcanista",
    warlock: "Tessitore di Rovina",
    druid: "Mutaforma Selvaggio",
    warriorAria: "Classe Guardiano",
    paladinAria: "Classe Giurato",
    hunterAria: "Classe Ranger",
    rogueAria: "Classe Lama Ombrosa",
    priestAria: "Classe Chierico",
    shamanAria: "Classe Evocaspiriti",
    mageAria: "Classe Arcanista",
    warlockAria: "Classe Tessitore di Rovina",
    druidAria: "Classe Mutaforma Selvaggio",
  },
  controls: {
...
export const de_DE: typeof en = {
  ...
  classes: {
    warrior: "Wächter",
    paladin: "Lichtgeschworener",
    hunter: "Waldläufer",
    rogue: "Schattenklinge",
    priest: "Kleriker",
    shaman: "Geisterrufer",
    mage: "Arkanist",
    warlock: "Schicksalsweber",
    druid: "Wildgestaltwandler",
    warriorAria: "Wächter-Klasse",
    paladinAria: "Lichtgeschworener-Klasse",
    hunterAria: "Waldläufer-Klasse",
    rogueAria: "Schattenklinge-Klasse",
    priestAria: "Kleriker-Klasse",
    shamanAria: "Geisterrufer-Klasse",
    mageAria: "Arkanist-Klasse",
    warlockAria: "Schicksalsweber-Klasse",
    druidAria: "Wildgestaltwandler-Klasse",
  },
  controls: {
...
export const pt_BR: typeof en = {
  ...
  classes: {
    ...
    paladin: "Juramentado",
    hunter: "Patrulheiro",
    rogue: "Lâmina Sombria",
    priest: "Clérigo",
    shaman: "Invocador de Espíritos",
    mage: "Arcanista",
    warlock: "Tecelão da Ruína",
    druid: "Metamorfo Selvagem",
    warriorAria: "Classe Guardião",
    paladinAria: "Classe Juramentado",
    hunterAria: "Classe Patrulheiro",
    rogueAria: "Classe Lâmina Sombria",
    priestAria: "Classe Clérigo",
    shamanAria: "Classe Invocador de Espíritos",
    mageAria: "Classe Arcanista",
    warlockAria: "Classe Tecelão da Ruína",
    druidAria: "Classe Metamorfo Selvagem",
  },
  controls: {
...
export const ru_RU: typeof en = {
  ...
  classes: {
    warrior: "Страж",
    paladin: "Светоприсягнувший",
    hunter: "Следопыт",
    rogue: "Теневой Клинок",
    priest: "Жрец",
    shaman: "Призыватель Духов",
    mage: "Чародей",
    warlock: "Ткач Гибели",
    druid: "Дикий Перевёртыш",
    warriorAria: "Класс Страж",
    paladinAria: "Класс Светоприсягнувший",
    hunterAria: "Класс Следопыт",
    rogueAria: "Класс Теневой Клинок",
    priestAria: "Класс Жрец",
    shamanAria: "Класс Призыватель Духов",
    mageAria: "Класс Чародей",
    warlockAria: "Класс Ткач Гибели",
    druidAria: "Класс Дикий Перевёртыш",
  },
  controls: {
