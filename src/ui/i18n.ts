...
const phase8En = {
  ...
  entities: {
    ...
    items: itemTranslations([
      ...
      "Rusted Censer", "Sablefen Troll Fetish", "Grubjaw's Tusk", "Bonecaller Cipher", "Bastion Ward Stone", "Deacon's Cleaver", "Staff of Drowned Prayers",
      "Mistbinder Kris", "Drownedguard Breastplate", "Fenmist Robe", "Eelskin Tunic", "Trollhide Leggings", "Marshstrider Boots", "Fogcaller's Edge", "Vael's Mist-Staff",
      ...
      "Kazzix's Heartshard", "Wyrmcult Orders", "Ritual Phylactery", "Wyrmbarrow Sigil", "Blessed Embers", "Sanctum Key Shard", "Ridgestalker Treads", "Boneplate Vest",
      ...
      "Gutripper Shiv", "Stormshard Leggings", "Korgath's Chainwraps", "Boneguard Breastplate", "Staff of Velkhar", "Shadowmeld Tunic", "Wyrmbarrow Scale Hauberk",
      "Wyrmcult Grand Robe", "Wyrmscale Jerkin", "Wyrmfang Greatblade", "Staff of the Wyrmbarrow", "Fang of Korzul", "Wardenwatch Trail Hardtack", "Meltwater Flask",
  ...
  es: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Incensario oxidado", "Fetiche trol de Sablefen", "Colmillo de Grubjaw", "Cifra de Bonecaller", "Piedra de guarda del Bastión", "Cuchilla del diácono", "Bastón de plegarias ahogadas",
        "Cris atanieblas", "Coraza de Guardia Ahogada", "Toga de niebla del pantano", "Túnica de piel de anguila", "Leotardos de piel de trol", "Botas Zancapantanos", "Filo de Fogcaller", "Bastón de niebla de Vael",
        ...
        "Fragmento del corazón de Kazzix", "Órdenes del Culto del Wyrm", "Filacteria ritual", "Sigilo del Wyrmbarrow", "Brasas benditas", "Fragmento de llave del santuario", "Botines Acechacrestas", "Chaleco de placas óseas",
        ...
        "Navaja Desgarratripas", "Leotardos de fragmento de tormenta", "Envolturas de malla de Korgath", "Coraza Guardahuesos", "Bastón de Velkhar", "Túnica Fundesombra", "Loriga de escamas de Wyrmbarrow",
        "Gran toga del Culto del Wyrm", "Jubón de escamas de wyrm", "Gran hoja Colmillo de Wyrm", "Bastón del Wyrmbarrow", "Colmillo de Korzul", "Galleta de viaje de Wardenwatch", "Frasco de agua de deshielo",
  ...
  fr_FR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Encensoir rouillé", "Fétiche troll de Sablefen", "Défense de Grubjaw", "Chiffre de Bonecaller", "Pierre de garde du Bastion", "Fendoir du diacre", "Bâton des prières noyées",
        "Kris Lie-brume", "Cuirasse Garde-noyé", "Robe de brume des marais", "Tunique en peau d'anguille", "Jambières en peau de troll", "Bottes Marchemarais", "Tranchant de Fogcaller", "Bâton de brume de Vael",
        ...
        "Éclat de coeur de Kazzix", "Ordres du Culte du Wyrm", "Phylactère rituel", "Sceau du Wyrmbarrow", "Braises bénies", "Éclat de clé du sanctuaire", "Bottines Traquecrête", "Gilet de plaques d'os",
        ...
        "Surin Éventreur", "Jambières d'éclat de tempête", "Enveloppes de mailles de Korgath", "Cuirasse Garde-os", "Bâton de Velkhar", "Tunique Fondombre", "Haubert d'écailles de Wyrmbarrow",
        "Grande robe du Culte du Wyrm", "Pourpoint en écailles de wyrm", "Grande lame Croc-de-wyrm", "Bâton du Wyrmbarrow", "Croc de Korzul", "Biscuit de route de Wardenwatch", "Flasque d'eau de fonte",
  ...
  it_IT: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Turibolo arrugginito", "Feticcio troll di Sablefen", "Zanna di Grubjaw", "Cifrario di Bonecaller", "Pietra di guardia del Bastione", "Mannaia del diacono", "Bastone delle preghiere annegate",
        "Kris Leganebbia", "Corazza Guardia Annegata", "Veste di nebbia palustre", "Tunica di pelle d'anguilla", "Gambiere di pelle di troll", "Stivali Passapaludi", "Filo di Fogcaller", "Bastone di nebbia di Vael",
        ...
        "Scheggia del cuore di Kazzix", "Ordini del Culto del Wyrm", "Filatterio rituale", "Sigillo del Wyrmbarrow", "Braci benedette", "Scheggia di chiave del santuario", "Calzari Inseguicrinale", "Gilet di piastre ossee",
        ...
        "Stiletto Sventraviscere", "Gambiere Scheggiatempesta", "Fasce di maglia di Korgath", "Corazza GuardiadiOssa", "Bastone di Velkhar", "Tunica Fondombra", "Usbergo di scaglie di Wyrmbarrow",
        "Grande veste del Culto del Wyrm", "Giaco di scaglie di wyrm", "Spadone Zanna di Wyrm", "Bastone del Wyrmbarrow", "Zanna di Korzul", "Galletta da sentiero di Wardenwatch", "Fiasca di acqua di disgelo",
  ...
  de_DE: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Kazzix' Herzsplitter", "Befehle des Wyrmkults", "Rituelles Seelengefäß", "Wyrmbarrow-Siegel", "Gesegnete Glut", "Heiligtums-Schlüsselsplitter", "Gratpirschertreter", "Knochenplattenweste",
        ...
        "Bauchreißer-Shiv", "Sturmsplittergamaschen", "Korgaths Kettenwickel", "Knochenwachtbrustplatte", "Stab von Velkhar", "Schattenverschmelzungstunika", "Wyrmbarrow-Schuppenhalsberge",
  ...
  pt_BR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Incensário enferrujado", "Fetiche troll de Sablefen", "Presa de Grubjaw", "Cifra de Bonecaller", "Pedra de guarda do Bastião", "Cutelo do diácono", "Cajado das preces afogadas",
        "Kris Prendenévoa", "Peitoral da Guarda Afogada", "Veste de névoa do brejo", "Túnica de pele de enguia", "Perneiras de pele de troll", "Botas Passabrejo", "Gume de Fogcaller", "Cajado de névoa de Vael",
        ...
        "Estilhaço do coração de Kazzix", "Ordens do Culto do Wyrm", "Filactério ritual", "Sigilo do Wyrmbarrow", "Brasas abençoadas", "Estilhaço da chave do santuário", "Sapatilhas Espreita-crista", "Colete de placas ósseas",
        ...
        "Faca Rasga-entranhas", "Perneiras de estilhaço de tempestade", "Envoltórios de malha de Korgath", "Peitoral Guardião dos Ossos", "Cajado de Velkhar", "Túnica Fundesombra", "Cota de escamas do Wyrmbarrow",
        "Grande veste do Culto do Wyrm", "Gibão de escamas de wyrm", "Grande lâmina Presa de Wyrm", "Cajado do Wyrmbarrow", "Presa de Korzul", "Biscoito de trilha de Wardenwatch", "Frasco de água de degelo",
...
const phase11EntitiesEn = {
  items: phase11NameTranslations(PHASE11_ITEM_IDS, [
    ...
    "Fen Reaver Glaive", "Gorrak's Cruel Chopper", "Gravepath Treads", "Gravewoven Raiment", "Wyrmbarrow Sabatons", "Wyrmbarrow Stalker's Treads",
  ...
  mobs: phase11NameTranslations(PHASE11_MOB_IDS, [
    ...
    "Mogger", "Mogger Lackey", "Nhalia Mourner", "Duskweb Hatchling", "Duskweb Matriarch", "Sister Nhalia", "Varkas Boneguard",
    "Imp", "Voidwalker",
  ], 'mob'),
  quests: {
    q_mogger_tracks: {
    ...
    q_mogger: {
      ...
      completion: "Mogger is dead at last. Greywillow's fields are safer, and you leave the Vale with one more tale worth retelling.",
...
const phase11Entities = {
  ...
  es: {
    items: phase11NameTranslations(PHASE11_ITEM_IDS, [
      ...
      "Guja del Segador del pantano", "Tajadora cruel de Gorrak", "Botines Caminotumba", "Vestidura Tejetumba", "Escarpes del Wyrmbarrow", "Botines de acechador del Wyrmbarrow",
    ...
    mobs: phase11NameTranslations(PHASE11_MOB_IDS, [
      ...
      "Mogger", "Esbirro de Mogger", "Doliente de Nhalia", "Cría Duskweb", "Matriarca Duskweb", "Hermana Nhalia", "Guardahuesos de Varkas",
      "Diablillo", "Caminante del Vacío",
    ], 'mob'),
    quests: {
      q_mogger_tracks: {
        title: "El rastro de Mogger",
        text: "Antes de tomar el camino al norte, Greywillow tiene una última espina clavada: Mogger. La bestia pisotea el prado bajo y enloquece a los jabalíes. Limpia la zona de su rastro para que veamos dónde se esconde.",
      ...
      q_mogger: {
        ...
        completion: "Mogger ha muerto por fin. Los campos de Greywillow son más seguros, y sales del Valle con otra historia digna de contarse.",
  ...
  fr_FR: {
    items: phase11NameTranslations(PHASE11_ITEM_IDS, [
      ...
      "Glaive du faucheur des marais", "Tranchoir cruel de Gorrak", "Bottines Sentetombe", "Habit tissé de tombe", "Solerets du Wyrmbarrow", "Bottines du traqueur de Wyrmbarrow",
    ...
    mobs: phase11NameTranslations(PHASE11_MOB_IDS, [
      ...
      "Mogger", "Laquais de Mogger", "Pleureuse de Nhalia", "Jeune Duskweb", "Matriarche Duskweb", "Soeur Nhalia", "Garde-os de Varkas",
      "Diablotin", "Marcheur du Vide",
    ], 'mob'),
    quests: {
      q_mogger_tracks: {
        title: "La piste de Mogger",
        text: "Avant de prendre la route du nord, Greywillow a une dernière épine dans le pied : Mogger. La brute piétine le pré bas et rend les sangliers fous. Nettoyez le pré autour de sa piste pour que nous voyions où il se terre.",
      ...
      q_mogger: {
        ...
        completion: "Mogger est enfin mort. Les champs de Greywillow sont plus sûrs, et vous quittez le Val avec une histoire de plus à raconter.",
  ...
  it_IT: {
    items: phase11NameTranslations(PHASE11_ITEM_IDS, [
      ...
      "Falcione del Razziatore delle paludi", "Mannaia crudele di Gorrak", "Calzari Sentierotomba", "Paramento Intessitomba", "Calzari del Wyrmbarrow", "Calzari del braccatore del Wyrmbarrow",
    ...
    mobs: phase11NameTranslations(PHASE11_MOB_IDS, [
      ...
      "Mogger", "Lacchè di Mogger", "Piangente di Nhalia", "Piccolo Duskweb", "Matriarca Duskweb", "Sorella Nhalia", "Guardia d'ossa di Varkas",
      "Folletto", "Camminatore del Vuoto",
    ], 'mob'),
    quests: {
      q_mogger_tracks: {
        title: "La traccia di Mogger",
        text: "Prima di prendere la strada a nord, Greywillow ha un'ultima spina nel fianco: Mogger. Il bruto calpesta il prato basso e fa impazzire i cinghiali. Ripulisci il prato attorno alla sua traccia per scoprire dove si tana.",
      ...
      q_mogger: {
        ...
        completion: "Mogger è morto finalmente. I campi di Greywillow sono più sicuri, e lasci il Valle con un'altra storia da raccontare.",
  ...
  de_DE: {
    ...
    mobs: phase11NameTranslations(PHASE11_MOB_IDS, [
      ...
      "Mogger", "Moggers Lakai", "Nhalia-Trauernde", "Duskweb-Jungtier", "Duskweb-Matriarchin", "Schwester Nhalia", "Varkas' Knochenwache",
      "Wichtel", "Leerwandler",
    ], 'mob'),
    quests: {
      q_mogger_tracks: {
        title: "Moggers Spur",
        text: "Bevor du die Straße nach Norden nimmst, hat Greywillow noch einen letzten Dorn im Fleisch: Mogger. Der Grobian zertrampelt die untere Wiese und treibt die Eber in den Wahnsinn. Säubere die Wiese um seine Spur, damit wir sehen, wo er haust.",
      ...
      q_mogger: {
        ...
        completion: "Mogger ist endlich tot. Greywillows Felder sind sicherer, und du verlässt das Tal mit einer weiteren Geschichte, die es wert ist erzählt zu werden.",
  ...
  pt_BR: {
    items: phase11NameTranslations(PHASE11_ITEM_IDS, [
      ...
      "Glaive do Ceifador do brejo", "Cutelo cruel de Gorrak", "Pisantes Caminho-túmulo", "Traje Tecetumba", "Escarpes do Wyrmbarrow", "Pisantes de espreitador do Wyrmbarrow",
    ...
    mobs: phase11NameTranslations(PHASE11_MOB_IDS, [
      ...
      "Mogger", "Lacaio de Mogger", "Pranteadora de Nhalia", "Filhote Duskweb", "Matriarca Duskweb", "Irmã Nhalia", "Guardião dos ossos de Varkas",
      "Diabrete", "Caminhante do Vazio",
    ], 'mob'),
    quests: {
      q_mogger_tracks: {
        title: "A trilha de Mogger",
        text: "Antes de pegar a estrada ao norte, Greywillow tem um último espinho: Mogger. A fera pisoteia o prado baixo e enlouquece os javalis. Limpe o prado ao redor da trilha para descobrirmos onde ele se esconde.",
      ...
      q_mogger: {
        ...
        completion: "Mogger está morto enfim. Os campos de Greywillow estão mais seguros, e você deixa o Vale com mais uma história digna de ser contada.",
        objectives: { 0: { label: "Mogger abatido" } },
      },
    },
  },
