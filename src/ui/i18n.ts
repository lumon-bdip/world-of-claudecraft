...
const phase8En = {
  ...
  entities: {
    ...
    items: itemTranslations([
      ...
      "Hobnailed Boots", "Greywillow Wool Trousers", "Gravecaller's Broadblade", "Widowfang Dirk", "Staff of the Hollow", "Marrowtread Boots", "Sexton's Slippers",
      "Gravewalker Softboots", "Bristly Boar Hide", "Gravecaller's Sigil", "Blessed Tallow", "Ghostly Essence", "Tanglemoor Silk Gland", "Stolen Supply Crate",
      ...
      "Rusted Censer", "Sablefen Troll Fetish", "Grubjaw's Tusk", "Gravecaller Cipher", "Bastion Ward Stone", "Deacon's Cleaver", "Staff of Drowned Prayers",
      ...
      "Wyrmcult Grand Robe", "Wyrmscale Jerkin", "Wyrmfang Greatblade", "Staff of the Gravewyrm", "Fang of Korzul", "Wardenwatch Trail Hardtack", "Meltwater Flask",
  ...
  es: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Botas claveteadas", "Pantalones de lana de Greywillow", "Mandoble de Gravecaller", "Puñal Colmillo de Viuda", "Bastón del Hueco", "Botas Pisatuétanos", "Zapatillas del sacristán",
        "Botas blandas del Caminante de Tumbas", "Piel erizada de jabalí", "Sigilo de Gravecaller", "Sebo bendito", "Esencia fantasmal", "Glándula de seda de Tanglemoor", "Cajón de suministros robado",
        ...
        "Incensario oxidado", "Fetiche trol de Sablefen", "Colmillo de Grubjaw", "Cifra de Gravecaller", "Piedra de guarda del Bastión", "Cuchilla del diácono", "Bastón de plegarias ahogadas",
        ...
        "Gran toga del Culto del Wyrm", "Jubón de escamas de wyrm", "Gran hoja Colmillo de Wyrm", "Bastón del Gravewyrm", "Colmillo de Korzul", "Galleta de viaje de Wardenwatch", "Frasco de agua de deshielo",
  ...
  fr_FR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Bottes cloutées", "Pantalon de laine de Greywillow", "Grande lame de Gravecaller", "Dague Croc-de-veuve", "Bâton du Creux", "Bottes Fouletombe", "Mules du sacristain",
        "Bottes souples Marchetombe", "Peau hérissée de sanglier", "Sceau de Gravecaller", "Suif béni", "Essence spectrale", "Glande de soie de Tanglemoor", "Caisse de fournitures volée",
        ...
        "Encensoir rouillé", "Fétiche troll de Sablefen", "Défense de Grubjaw", "Chiffre de Gravecaller", "Pierre de garde du Bastion", "Fendoir du diacre", "Bâton des prières noyées",
        ...
        "Grande robe du Culte du Wyrm", "Pourpoint en écailles de wyrm", "Grande lame Croc-de-wyrm", "Bâton du Gravewyrm", "Croc de Korzul", "Biscuit de route de Wardenwatch", "Flasque d'eau de fonte",
  ...
  it_IT: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Stivali chiodati", "Pantaloni di lana di Greywillow", "Lama larga di Gravecaller", "Pugnale Zanna di Vedova", "Bastone del Vuoto", "Stivali Passomidollo", "Pantofole del sagrestano",
        "Stivaletti morbidi del Camminatombe", "Pelle ispida di cinghiale", "Sigillo di Gravecaller", "Sego benedetto", "Essenza spettrale", "Ghiandola di seta di Tanglemoor", "Cassa di rifornimenti rubata",
        ...
        "Turibolo arrugginito", "Feticcio troll di Sablefen", "Zanna di Grubjaw", "Cifrario di Gravecaller", "Pietra di guardia del Bastione", "Mannaia del diacono", "Bastone delle preghiere annegate",
        ...
        "Grande veste del Culto del Wyrm", "Giaco di scaglie di wyrm", "Spadone Zanna di Wyrm", "Bastone del Gravewyrm", "Zanna di Korzul", "Galletta da sentiero di Wardenwatch", "Fiasca di acqua di disgelo",
  ...
  de_DE: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Nagelstiefel", "Greywillow-Wollhose", "Gravecallers Breitschwert", "Witwenzahn-Dolch", "Stab der Höhlung", "Markschrittstiefel", "Pantoffeln des Küsters",
        "Weiche Grabwandlerstiefel", "Borstige Eberhaut", "Gravecallers Siegel", "Gesegneter Talg", "Geisterhafte Essenz", "Seidendrüse von Tanglemoor", "Gestohlene Vorratskiste",
        ...
        "Rostiges Räuchergefäß", "Sablefen-Trollfetisch", "Grubjaws Hauer", "Gravecaller-Chiffre", "Bastion-Wachstein", "Beil des Diakons", "Stab ertrunkener Gebete",
        ...
        "Große Robe des Wyrmkults", "Wyrmschuppenwams", "Wyrmzahn-Großklinge", "Stab des Gravewyrm", "Korzuls Fangzahn", "Wardenwatch-Reisezwieback", "Schmelzwasserflasche",
  ...
  pt_BR: {
    ...
    entities: {
      ...
      items: itemTranslations([
        ...
        "Botas cravejadas", "Calças de lã de Greywillow", "Lâmina larga de Gravecaller", "Punhal Presa-de-viúva", "Cajado do Vazio", "Botas Pisamedula", "Pantufas do sacristão",
        "Botas macias do Andatumbas", "Pele eriçada de javali", "Sigilo de Gravecaller", "Sebo abençoado", "Essência espectral", "Glândula de seda de Tanglemoor", "Caixote de suprimentos roubado",
        ...
        "Incensário enferrujado", "Fetiche troll de Sablefen", "Presa de Grubjaw", "Cifra de Gravecaller", "Pedra de guarda do Bastião", "Cutelo do diácono", "Cajado das preces afogadas",
        ...
        "Grande veste do Culto do Wyrm", "Gibão de escamas de wyrm", "Grande lâmina Presa de Wyrm", "Cajado do Gravewyrm", "Presa de Korzul", "Biscoito de trilha de Wardenwatch", "Frasco de água de degelo",
