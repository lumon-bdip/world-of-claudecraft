...
export const id_ID: EnTranslations = {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_prof_hobby_switch": {
        "title": "Kegemaran yang Berbeda",
        "text": "Keahlian utama menuntut sumpah. Hobi hanya bertanya ke mana rasa ingin tahumu mengembara, {playerName}. Kumpulkan beberapa herba dan tentukan keahlian di seberang keahlian utamamu yang ingin kamu tekuni.",
        "completion": "Pilihan yang lebih ringan, tetapi berguna. Ikuti rasa ingin tahu itu sejauh karya langka dapat membawamu.",
        "objectives": {
          "0": {
