...
export const cs_CZ: EnTranslations = {
  ...
  "entities": {
    ...
    "quests": {
      ...
      "q_prof_hobby_switch": {
        "title": "Jiná záliba",
        "text": "Hlavní řemesla vyžadují slib. Záliba se ptá jen na to, kam tě zavede zvědavost, {playerName}. Nasbírej několik bylin a rozhodni se, kterému řemeslu naproti tvým hlavním řemeslům se chceš věnovat.",
        "completion": "Lehčí volba, ale užitečná. Následuj svou zvědavost tak daleko, jak tě vzácná práce zavede.",
        "objectives": {
          "0": {
            "label": "Sklizeno bylinné naleziště"
          }
        }
      },
      "q_drowned_choir": {
