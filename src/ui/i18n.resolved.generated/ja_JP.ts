...
export const ja_JP: EnTranslations = {
  ...
  "guide": {
    ...
    "deedsPage": {
      ...
      "howHeading": "功績の仕組み",
      "howBody": "功績はそれぞれ一人のキャラクターの手で獲得され、アカウント全体に表示されます。あなたが遊ぶどの英雄も、同じ一つのコレクションに加わっていくのです。それぞれの功績が何を求めているかは、ゲーム内の功績の書にはっきりと記されているので、次に何を追うべきかはいつでも分かります。狙っている功績を追跡リストに載せておけば、遊んでいる間もずっと視界に入れておけます。ごく一部の功績は秘密のままで、獲得して初めて姿を現します。",
      "renownHeading": "名声",
