  ...
  entities: {
    abilities: abilityTranslations([
      ...
      [
        'summon_imp',
        'Summon Emberkin',
        'Summons an Imp under the command of the Warlock. The Imp hurls Ashbolts at your enemies from afar. Summoning a new demon dismisses your current one. You may have one demon at a time.',
      ],
      [
        'summon_voidwalker',
        'Summon Gloomshade',
      ...
      [
        'summon_felhunter',
        'Summon Spellhound',
        'Summons a Felhunter under the command of the Warlock. The Felhunter harries enemies from range with Gloombite and excels at hunting spellcasters. Summoning a new demon dismisses your current one. You may have one demon at a time.',
      ],
      [
        'summon_felguard',
        'Summon Warfiend',
