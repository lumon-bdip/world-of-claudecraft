...
const classAbilityNamesEn = {
  entities: {
    abilities: abilityTranslations([
      ...
      ['battle_shout', 'Iron Bellow', 'Increases your attack power by {buff} for 2 min.'],
      ...
      ['arcane_intellect', 'Aether Insight', 'Increases Intellect by {buff} for 30 min.'],
      [
        'frostbolt',
        'Rimelance',
      ...
      ['devotion_aura', 'Steadfast Aura', 'Increases your armor by {buff} for 30 min.'],
      [
        'judgement',
        'Verdict',
      ...
      [
        'blessing_of_might',
        'Oath of Iron',
        'Places a Blessing on a friendly target, increasing attack power by {buff} for 5 min.',
      ],
      [
        'divine_protection',
        'Ward of Faith',
      ...
      [
        ...
        'Litany of Resolve',
        "Increases the target's Stamina by {buff} for 30 min.",
      ],
      [
        'shadow_word_pain',
        'Dirge of Decay',
      ...
      [
        'mark_of_the_wild',
        'Wildward',
        'Places the Wildward on a friendly target, increasing armor by {buff} for 30 min.',
      ],
      [
        'moonfire',
        'Lunar Tempest',
      ...
      ['faerie_fire', 'Witchlight', "Decreases the target's armor by 35 for 30 sec."],
      [
        'hibernate',
        'Slumber',
