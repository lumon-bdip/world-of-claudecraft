...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.deedsPage.cat.pvp': 'Spelare mot spelare',
  'guide.deedsPage.cat.social': 'Socialt och ekonomi',
  ...
  'guide.deedsPage.standingsNote':
    'Rikena för en löpande räkning av ryktbarhet över alla konton. Vill du se vem som står var, öppna Bedrifternas bok i spelet och slå upp ryktbarhetslistan; den finns där, inte på wikin.',
