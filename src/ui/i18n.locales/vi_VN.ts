...
export const vi_VN: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.deedsPage.cat.pvp': 'Người Chơi Đấu Với Người Chơi',
  'guide.deedsPage.cat.social': 'Xã Hội và Kinh Tế',
  ...
  'guide.deedsPage.standingsNote':
    'Các vương quốc luôn ghi sổ Danh Vọng của mọi tài khoản. Muốn biết ai đứng ở đâu, hãy mở Sách Kỳ Công trong trò chơi và lật đến bảng xếp hạng Danh Vọng; bảng này nằm ở đó, không nằm trên wiki.',
