...
const baseEnTable = {
  ...
  'aura.elixirThickHide': 'Thick Hide',
...
const BASE_DICT: Record<SupportedLanguage, Partial<Record<BaseSimMessageKey, string>>> = {
  ...
  es: {
    ...
    'aura.elixirThickHide': 'Piel Gruesa',
  ...
  fr_FR: {
    ...
    'aura.elixirThickHide': 'Peau Épaisse',
  ...
  it_IT: {
    ...
    'aura.elixirThickHide': 'Pelle Spessa',
  ...
  de_DE: {
    ...
    'aura.elixirThickHide': 'Dicke Haut',
  ...
  pt_BR: {
    ...
    'aura.elixirThickHide': 'Pele Grossa',
  ...
  ru_RU: {
    ...
    'aura.elixirThickHide': 'Толстая Шкура',
...
const AURA_NAME_KEY: Record<string, SimMessageKey> = {
  ...
  'Thick Hide': 'aura.elixirThickHide',
