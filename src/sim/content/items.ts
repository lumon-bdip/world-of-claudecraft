...
export const BASE_ITEMS: Record<string, ItemDef> = {
  ...
  eastbrook_chain_vest: {
    id: 'eastbrook_chain_vest', name: 'Greywillow Chainmail Vest', kind: 'armor', slot: 'chest', quality: 'common',
  ...
  eastbrook_wool_trousers: {
    id: 'eastbrook_wool_trousers', name: 'Greywillow Wool Trousers', kind: 'armor', slot: 'legs', quality: 'common',
