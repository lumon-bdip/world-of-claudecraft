...
export const ZONE1_QUESTS: Record<string, QuestDef> = {
  ...
  q_ringleader: {
    ...
    completionText: 'Gorrak is dead? Then the Vale is free of his shadow. You have done Greywillow a great service.',
  ...
  q_mogger_tracks: {
    ...
    giverNpcId: 'marshal_redbrook', turnInNpcId: 'marshal_redbrook',
    text: "Before you take the road north, Greywillow has one last thorn in its side: Mogger. The brute has been trampling the lower meadow and driving the boars mad. Clear the meadow around his trail so we can see where he lairs.",
  ...
  q_mogger: {
    ...
    completionText: "Mogger dead at last. Greywillow's fields are safer, and you leave the Vale with one more tale worth retelling.",
